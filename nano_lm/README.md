...
Card: [`docs/results/nano-lm/champion-card.md`](../docs/results/nano-lm/champion-card.md) · Recipes: [`RECIPES.md`](../docs/results/nano-lm/RECIPES.md) · Lab: `.local/pesquisa.md` (**Wave X**: H-TCHR/H-QT **PROMOTE**; H-RAG/H-CTX/H-CKD/H-QCTX/H-QCOMP **KILL**; next H-Q-QUBITKV).

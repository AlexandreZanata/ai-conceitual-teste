"""Smoke H-PRE3: 3-deep prefetch under PRE2 vs 2-deep PRE2."""
...
def main() -> int:
    ...
    if device.type != "cuda":
        print("ERROR: H-PRE3 requires CUDA", file=sys.stderr)
        return 2
    out = c["out"]
    ...
    print(json.dumps({"n_rows": len(rows), "out": str(out / "pre3_smoke.json")}))
    return 0

"""Formal-budget H-PARE vs B4 (Pareto knee claim), shared B2 ckpts."""
...
def formal_cfg() -> dict[str, Any]:
    ...
    base["out"] = REPO / "results/nano-lm/formal-hpare"

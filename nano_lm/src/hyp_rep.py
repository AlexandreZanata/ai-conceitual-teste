"""H-REP: grid-search repetition penalty on B2 student; claim vs B4."""
...
from rep_ops import PENALTIES, best_penalty_index
...
def run_h_rep(
    *,
    ...
    for j, pen in enumerate(PENALTIES):
        ...
        fit_lps.append(lp)
    best_i = best_penalty_index(fit_lps)
    best_pen = float(PENALTIES[best_i])
    eval_lp, eval_wall = _score_penalty(
        penalty=best_pen,
        teacher=teacher,
        student=student,

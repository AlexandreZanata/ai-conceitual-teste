"""Formal-budget H-BEAM vs B4 (evolved beam), shared B2 ckpts."""
...
def formal_cfg() -> dict[str, Any]:
    ...
    base["out"] = REPO / "results/nano-lm/formal-hbeam"
...
def _eval_gene(c: dict[str, Any], ckpt: Path, gene: dict, seed: int) -> dict:
    ...
    lp, wall_ms = fitness_beam_detail(
        gene,
        teacher=teacher,
        student=student,
        prompts=texts,
...
def run_formal() -> int:
    ...
    for seed in c["seeds"]:
        ...
        meta = run_h_beam(
            ...
            seed=seed,
            lam=MIN_LAM,
            out_meta=c["out"] / f"HBEAM_seed{seed}_train.json",
        )

"""Formal-budget H-DRAFT vs B4 (evolved draft knobs), shared B2 ckpts."""
...
def formal_cfg() -> dict[str, Any]:
    ...
    base["out"] = REPO / "results/nano-lm/formal-hdraft"
...
def _eval_gene(c: dict[str, Any], ckpt: Path, gene: dict, seed: int) -> dict:
    ...
    lp, wall_ms = fitness_draft_detail(
        gene,
        teacher=teacher,
        student=student,
        prompts=texts,
...
def run_formal() -> int:
    ...
    for seed in c["seeds"]:
        ...
        meta = run_h_draft(
            ...
            seed=seed,
            lam=MIN_LAM,
            out_meta=c["out"] / f"HDRAFT_seed{seed}_train.json",
        )

"""Two-phase decode: short draft, continue only if student conf low."""
...
def decode_short(
    ...
    *,
    ...
    if int(draft_max) < 1 or int(draft_max) > int(max_new_tokens):

"""Formal-budget H-EARLY vs B4 (early-exit), shared B2 ckpts."""
...
def formal_cfg() -> dict[str, Any]:
    ...
    base["out"] = REPO / "results/nano-lm/formal-hearly"
...
def _eval_gene(c: dict[str, Any], ckpt: Path, gene: dict, seed: int) -> dict:
    ...
    lp, wall_ms = fitness_early_detail(
        gene,
        teacher=teacher,
        student=student,
        prompts=texts,
...
def run_formal() -> int:
    ...
    for seed in c["seeds"]:
        ...
        meta = run_h_early(
            ...
            seed=seed,
            lam=MIN_LAM,
            out_meta=c["out"] / f"HEARLY_seed{seed}_train.json",
        )

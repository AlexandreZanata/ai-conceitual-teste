"""Contract: H-Q-INTERF smoke KILL is archived with effect sizes."""

from __future__ import annotations

from pathlib import Path

ARCHIVE = Path("docs/results/nano-lm/archive/hqinterf-interference.md")
...
def test_given_archive_when_read_then_kill_and_lesson() -> None:
    ...
    assert "-15.4650" in text
    assert "-7.9516" in text or "code" in text.lower()

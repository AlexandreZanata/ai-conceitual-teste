...
Decode utils: LAY/SHORT/FLASH/KVSEL/CHUNK/CHB/BAT/CBAT/CHBAT/POOLB/CPOOLB (tips unchanged).
...
- H-TOPK / H-Q4 formal KILL; H-CFUSE / **H-ASYNC** smoke KILL; **H-CBAT** / **H-CHB** / **H-CPOOLB** / **H-CHBAT** formal PROMOTE. Wave M: M2 done; next M3 (`.local/pesquisa.md`).

...
Decode utils: H-LAY / H-SHORT / H-FLASH / H-KVSEL / H-BAT / H-POOLB / H-CHUNK (tips unchanged).
...
H-CHUNK gate: lp ≥ EARLY−ε and wall < FLASH (chunked prefill; formal PROMOTE).
...
- Utils: LAY, SHORT, FLASH, KVSEL, BAT, POOLB, CHUNK, PRUN, TOP, DEPTH, PIN, FLOP.
- Wave K: **H-CHUNK** formal **PROMOTE**; **H-PIN** / **H-POOLB** PROMOTE; next **H-Q4**.

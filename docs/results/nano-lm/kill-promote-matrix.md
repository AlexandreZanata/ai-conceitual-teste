...
Decode utils: LAY/SHORT/FLASH/KVSEL/CHUNK/BAT/CBAT/POOLB (tips unchanged).
...
- H-TOPK / H-Q4 formal KILL; H-CFUSE smoke KILL; **H-CBAT** formal PROMOTE. Wave L next **H-CHB** (`.local/pesquisa.md`).

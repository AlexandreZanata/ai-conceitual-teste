...
Next: **AW3 H-NANOGEN7** — **DONE HOLD** (`npm run nano:nanogen7`) · **AW4 AW-REAL-EVAL** — **DONE PROMOTE** (`npm run nano:aw:real-eval`) · **AW5 AW-REPORT** — **DONE PROMOTE** (`npm run nano:aw:report`) · next **AW6 AW-FREEZE**.

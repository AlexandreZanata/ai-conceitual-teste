...
Next: **AS9 AS-REPORT** — **DONE PROMOTE** → [wave-as-summary.md](wave-as-summary.md) · [paper-lab-wave-as.md](paper-lab-wave-as.md). **AS10 AS-FREEZE** — **DONE PROMOTE** → [as-freeze.md](as-freeze.md). Do not invent Wave AT.

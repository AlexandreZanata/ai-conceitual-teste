# SHIPUI2 — mode always visible (ask · apps · ship/demo)
...
| PEAK | **PEAK** | `mode=PEAK · wall_ms=0.1435 · n_new=14 · raw=PEAK_FAST+GENBASE` |
| ABSTAIN | **ABSTAIN** | `mode=ABSTAIN · wall_ms=168.7897 · n_new=64 · raw=NO_ANSWER` |
...
| modeui_line | `mode=ABSTAIN · wall_ms=380.0505 · n_new=64 · raw=NO_ANSWER` |

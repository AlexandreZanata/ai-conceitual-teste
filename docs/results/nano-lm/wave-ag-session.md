...
Next: **AG1 H-ANTIFP** (**DONE** — see [formal-hantifp-antifp.md](formal-hantifp-antifp.md)). **AG2–AG7 DONE**. **AG8 AG-FREEZE** (**DONE — PROMOTE** — see [ag-freeze.md](ag-freeze.md) · [formal-hagfreeze-ag-freeze.md](formal-hagfreeze-ag-freeze.md)). Wave **AG COMPLETE + FROZEN**.

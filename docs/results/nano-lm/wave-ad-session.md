...
Next: **AD1 H-HARDPARA** (**DONE** — see [formal-hhardpara-hardpara.md](formal-hhardpara-hardpara.md)). **AD2 H-COMPOSE** (**DONE** — see [formal-hcompose-compose.md](formal-hcompose-compose.md)). **AD3 H-ROUTEPLUS** (**DONE** — see [formal-hrouteplus-routeplus.md](formal-hrouteplus-routeplus.md)). **AD4 H-DEPLPLUS** (**DONE** — see [formal-hdeplplus-deplplus.md](formal-hdeplplus-deplplus.md)). Next wave stage: **AD5 AD-HITL-10**.

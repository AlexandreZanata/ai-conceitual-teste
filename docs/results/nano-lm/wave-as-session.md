...
Next: **AS1 H-ASKABSTAIN** — **DONE PROMOTE** → [formal-haskabstain-askabstain.md](formal-haskabstain-askabstain.md). **AS2 H-SEMFIX** — **DONE PROMOTE** → [formal-hsemfix-semfix.md](formal-hsemfix-semfix.md). **AS3 H-ADVSAFE** — **DONE PROMOTE** → [formal-hadvsafe-advsafe.md](formal-hadvsafe-advsafe.md) (FH **0**/20). Next: **AS4 H-PARAEXT2**.

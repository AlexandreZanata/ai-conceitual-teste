...
Next: **AS1 H-ASKABSTAIN** — **DONE PROMOTE** → [formal-haskabstain-askabstain.md](formal-haskabstain-askabstain.md). **AS2 H-SEMFIX** — **DONE PROMOTE** → [formal-hsemfix-semfix.md](formal-hsemfix-semfix.md). **AS3 H-ADVSAFE** — **DONE PROMOTE** → [formal-hadvsafe-advsafe.md](formal-hadvsafe-advsafe.md) (FH **0**/20). **AS4 H-PARAEXT2** — **DONE PROMOTE** → [formal-hparaext2-paraext2.md](formal-hparaext2-paraext2.md) (hit **0.80**). **AS5 H-METRICS** — **DONE PROMOTE** → [formal-hmetrics-metrics.md](formal-hmetrics-metrics.md). Next: **AS6 H-SHIPUI**.

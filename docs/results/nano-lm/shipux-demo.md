# SHIPUX — mode always visible (ask · apps · ship/demo)
...
| PEAK | **PEAK** | `mode=PEAK · wall_ms=0.1351 · n_new=14 · raw=PEAK_FAST+GENBASE` |
| ABSTAIN | **ABSTAIN** | `mode=ABSTAIN · wall_ms=163.5633 · n_new=64 · raw=NO_ANSWER` |
...
| modeui_line | `mode=ABSTAIN · wall_ms=403.5090 · n_new=64 · raw=NO_ANSWER` |

...
**Wave AK OPEN:** AK0 [SESSION PROMOTE](wave-ak-session.md) (`npm run nano:ak:session`) · AK1 [H-GENTRUE HOLD](formal-hgentrue-gentrue.md) (`npm run nano:gentrue`) · AK2 [H-CTXMORE PROMOTE](formal-hctxmore-ctxmore.md) (`npm run nano:ctxmore`) — octa L_eff 188984; next **AK3 H-SMARTMORE**; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AL.

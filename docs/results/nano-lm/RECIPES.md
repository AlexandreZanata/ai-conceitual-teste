...
**Wave AU OPEN:** AU0 [SESSION PROMOTE](wave-au-session.md) (`npm run nano:au:session`) · AU1 [H-PRODHARD PROMOTE](formal-hprodhard-prodhard.md) (`npm run nano:prodhard`) — near-miss ABSTAIN · human para **1.0** · PEAK usable; next **AU2 H-SHIPREAL**; ship lock remains AT until AU PROMOTE.

...
| Wave AV6 AV-FREEZE | [av-freeze.md](av-freeze.md) · [formal-havfreeze-av-freeze.md](formal-havfreeze-av-freeze.md) **PROMOTE** (`npm run nano:av:freeze`) — COMPLETE+FROZEN; do not invent Wave AW |

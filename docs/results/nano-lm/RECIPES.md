...
| Wave AI1 H-GENPLUS | [formal-hgenplus-genplus.md](formal-hgenplus-genplus.md) **HOLD** (`npm run nano:genplus`) — grounded QPFB2 gen push; L=9.0 G=4.0; next AI1b CAPRENEG (optional) or AI2 H-CTXPUSH |

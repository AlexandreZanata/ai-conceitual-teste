...
**Wave AU OPEN:** AU0 [SESSION PROMOTE](wave-au-session.md) (`npm run nano:au:session`) — product-debt suite · human-para protocol · NANOGEN5 hyp (strict F1/HITL) · real-eval; next **AU1 H-PRODHARD**; ship lock remains AT until AU PROMOTE.

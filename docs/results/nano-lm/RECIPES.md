...
| Wave AW5 AW-REPORT | [wave-aw-summary.md](wave-aw-summary.md) · [paper-lab-wave-aw.md](paper-lab-wave-aw.md) **PROMOTE** (`npm run nano:aw:report`) — anti-FP · real-eval · RESEARCH_COMPLETE |
...
**Wave AW ACTIVE:** AW0 [SESSION PROMOTE](wave-aw-session.md) · AW1 [H-PRODKEEP PROMOTE](formal-hprodkeep-prodkeep.md) · AW2 [H-SHIPKEEP PROMOTE](formal-hshipkeep-shipkeep.md) · AW3 [H-NANOGEN7 HOLD](formal-hnanogen7-nanogen7.md) · AW4 [AW-REAL-EVAL PROMOTE](wave-aw-real-eval.md) · AW5 [AW-REPORT PROMOTE](wave-aw-summary.md) (`npm run nano:aw:report`) · [paper-lab-wave-aw.md](paper-lab-wave-aw.md); next AW6 AW-FREEZE; ship **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

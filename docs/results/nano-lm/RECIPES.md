...
**Wave AH OPEN:** AH0 [SESSION PROMOTE](wave-ah-session.md) (`npm run nano:ah:session`) — 7th held-out pack; next **AH1 H-GENLIFT**; ship claim remains **AF packaged stack** until AH6 gen bar.

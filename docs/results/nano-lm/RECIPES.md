...
Wave X+: [H-TCHR formal](formal-htchr-code-teacher.md) **PROMOTE**; [H-RAG](archive/hrag-retrieve.md) / [H-CTX](archive/hctx-long-window.md) **KILL**; next **H-QT** (`.local/pesquisa.md`).

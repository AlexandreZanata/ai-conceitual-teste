...
| Wave AO8 AO-FREEZE | [ao-freeze.md](ao-freeze.md) · [formal-haofreeze-ao-freeze.md](formal-haofreeze-ao-freeze.md) **PROMOTE** (`npm run nano:ao:freeze`) — COMPLETE+FROZEN; no Wave AP without reopen |

...
**Wave AH OPEN:** AH0 [SESSION PROMOTE](wave-ah-session.md) · AH1 [H-GENLIFT HOLD](formal-hgenlift-genlift.md) (`npm run nano:genlift`) — anti-period ok; gen **4.0** &lt; 5; next **AH2 H-CTXLIFT**; ship claim remains **AF packaged stack**.

...
**Wave AC OPEN:** AC0 [SESSION](wave-ac-session.md) · AC1 [H-CTXPLUS](formal-hctxplus-ctxplus.md) · AC2 [H-SMARTPLUS](formal-hsmartplus-smartplus.md) · AC3 [H-FASTPLUS](formal-hfastplus-fastplus.md) · AC4 [H-APPPLUS](formal-happplus-appplus.md) · AC5 [AC-HITL-10](wave-ac-hitl.md) — held-out ASK→EVAL→FIX (§8.5 · §12).

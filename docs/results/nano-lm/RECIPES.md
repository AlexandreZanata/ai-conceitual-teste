...
**Wave AT OPEN:** AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) — PRODREG suite · SHIPAPP charter · NANOGEN4 snippet-prefix hyp · real-eval battery; AT1 [H-PRODREG PROMOTE](formal-hprodreg-prodreg.md) (`npm run nano:prodreg`) — Caminho A bars hold; next AT2 H-SHIPAPP.

...
| Wave AI1b H-CAPRENEG | [formal-hcapreneg-capreneg.md](formal-hcapreneg-capreneg.md) **HOLD** (`npm run nano:capreneg`) — CAP-125M probe; gen 4.0; **keep ≤5M**; next AI2 H-CTXPUSH |

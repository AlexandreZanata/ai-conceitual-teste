...
| Wave AP8 AP-FREEZE | [ap-freeze.md](ap-freeze.md) · [formal-hapfreeze-ap-freeze.md](formal-hapfreeze-ap-freeze.md) **PROMOTE** (`npm run nano:ap:freeze`) — COMPLETE+FROZEN; no Wave AQ without reopen |

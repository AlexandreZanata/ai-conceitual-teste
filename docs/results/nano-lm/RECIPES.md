...
| Wave AH2 H-CTXLIFT | [formal-hctxlift-ctxlift.md](formal-hctxlift-ctxlift.md) **PROMOTE** (`npm run nano:ctxlift`) — penta-doc K=11; L_eff↑ vs CTXREAL; next AH3 H-SMARTLIFT |
...
**Wave AH OPEN:** AH0 [SESSION PROMOTE](wave-ah-session.md) · AH1 [H-GENLIFT HOLD](formal-hgenlift-genlift.md) · AH2 [H-CTXLIFT PROMOTE](formal-hctxlift-ctxlift.md) (`npm run nano:ctxlift`) — penta-doc L_eff↑; next **AH3 H-SMARTLIFT**; ship claim remains **AF packaged stack**.

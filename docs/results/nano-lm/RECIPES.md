...
| Wave AK7 AK-REPORT | [wave-ak-summary.md](wave-ak-summary.md) **PROMOTE** (`npm run nano:ak:report`) — public closeout + paper-lab; next AK8 AK-FREEZE |

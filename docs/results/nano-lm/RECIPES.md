...
**Wave AE OPEN:** AE0 [SESSION PROMOTE](wave-ae-session.md) · AE1 [H-CTXMAX PROMOTE](formal-hctxmax-ctxmax.md) · AE2 [H-SMARTMAX PROMOTE](formal-hsmartmax-smartmax.md) · AE3 [H-FASTMAX PROMOTE](formal-hfastmax-fastmax.md) · AE4 [H-APPMAX PROMOTE](formal-happmax-appmax.md) · next **AE-HITL-10** (ship claim remains AD stack until AE5).

...
| Wave AD1 HARDPARA | [formal-hhardpara-hardpara.md](formal-hhardpara-hardpara.md) **PROMOTE** (`npm run nano:hardpara`) — adversarial para; false-hit 0 |
...
**Wave AD OPEN:** AD0 [SESSION](wave-ad-session.md) · AD1 [H-HARDPARA](formal-hhardpara-hardpara.md) · AD2 [H-COMPOSE](formal-hcompose-compose.md) · AD3 [H-ROUTEPLUS](formal-hrouteplus-routeplus.md) · AD4 [H-DEPLPLUS](formal-hdeplplus-deplplus.md) — robust held-out · hard para · compose · route · deploy (§8.6 · §13).

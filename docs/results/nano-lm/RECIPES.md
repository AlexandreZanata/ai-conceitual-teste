**Wave BG ACTIVE:** BG0 [SESSION PROMOTE](wave-bg-session.md) · BG1 [H-UNARYINT PROMOTE](formal-hunaryint-unaryint.md) · BG2 [H-SHIPPUB PROMOTE](formal-hshippub-shippub.md) (`npm run nano:shippub`) — Track A++ done; next BG3 H-FASTBG; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

...
**Wave AT OPEN:** AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) — PRODREG suite · SHIPAPP charter · NANOGEN4 snippet-prefix hyp · real-eval battery; AT1 [H-PRODREG PROMOTE](formal-hprodreg-prodreg.md) (`npm run nano:prodreg`) — Caminho A bars hold; AT2 [H-SHIPAPP PROMOTE](formal-hshipapp-shipapp.md) (`npm run nano:shipapp`) — ask·apps·ship/demo 4/4; next AT3 H-NANOGEN4.

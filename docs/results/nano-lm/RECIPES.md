...
**Wave AW ACTIVE:** AW0 [SESSION PROMOTE](wave-aw-session.md) · AW1 [H-PRODKEEP PROMOTE](formal-hprodkeep-prodkeep.md) · AW2 [H-SHIPKEEP PROMOTE](formal-hshipkeep-shipkeep.md) · AW3 [H-NANOGEN7 HOLD](formal-hnanogen7-nanogen7.md) (`npm run nano:nanogen7`); next AW4 AW-REAL-EVAL; ship **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

...
**Wave AS OPEN:** AS0–AS6 product trust **PROMOTE** · AS7 [H-NANOGEN3 HOLD](formal-hnanogen3-nanogen3.md) (`npm run nano:nanogen3`) — ablated **4.3** · AS8 [AS-DUAL-HITL PROMOTE](wave-as-dual-hitl.md) (`npm run nano:as:dual-hitl`) — gen locked; next AS9 AS-REPORT.

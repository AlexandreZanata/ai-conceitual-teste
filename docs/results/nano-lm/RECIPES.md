...
**Wave AK OPEN:** AK0 [SESSION PROMOTE](wave-ak-session.md) (`npm run nano:ak:session`) — freeze 10 held-out ≠ AB…AJ; next **AK1 H-GENTRUE**; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AL.

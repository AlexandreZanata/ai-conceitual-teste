...
| Wave AQ8 AQ-REPORT | [wave-aq-summary.md](wave-aq-summary.md) · [paper-lab-wave-aq.md](paper-lab-wave-aq.md) **PROMOTE** (`npm run nano:aq:report`) — product + generative honesty; freeze pending AQ9 |
| Wave AQ9 AQ-FREEZE | [aq-freeze.md](aq-freeze.md) stub pending (`npm run nano:aq:freeze` when landed) |

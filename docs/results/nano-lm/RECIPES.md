...
**Wave AE OPEN:** AE0 [SESSION PROMOTE](wave-ae-session.md) · AE1 [H-CTXMAX PROMOTE](formal-hctxmax-ctxmax.md) · next **H-SMARTMAX** (ship claim remains AD stack until AE5).

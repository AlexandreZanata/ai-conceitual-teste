...
| Wave AQ3 H-LATP | [formal-hlatp-latp.md](formal-hlatp-latp.md) **PROMOTE** (`npm run nano:latp`) — LOOKUP 0/0 · PEAK 0.022/0.038 · DECODE 11.0/133; no FASTBASE regress; next AQ4 H-KBCOV |

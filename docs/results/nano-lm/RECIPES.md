...
**Wave AT OPEN:** AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) — PRODREG suite · SHIPAPP charter · NANOGEN4 snippet-prefix hyp · real-eval battery; AT1 [H-PRODREG PROMOTE](formal-hprodreg-prodreg.md) (`npm run nano:prodreg`) — Caminho A bars hold; AT2 [H-SHIPAPP PROMOTE](formal-hshipapp-shipapp.md) (`npm run nano:shipapp`) — ask·apps·ship/demo 4/4; AT3 [H-NANOGEN4 PROMOTE](formal-hnanogen4-nanogen4.md) (`npm run nano:nanogen4`) — ablated **5.5**; AT4 [AT-REAL-EVAL PROMOTE](wave-at-real-eval.md) (`npm run nano:at:real-eval`) — battery 6/6; AT5 [AT-REPORT PROMOTE](wave-at-summary.md) (`npm run nano:at:report`) · [paper-lab-wave-at.md](paper-lab-wave-at.md); next AT6 AT-FREEZE.

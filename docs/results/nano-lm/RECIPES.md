...
| Wave AJ8 AJ-FREEZE | [aj-freeze.md](aj-freeze.md) · [formal-hajfreeze-aj-freeze.md](formal-hajfreeze-aj-freeze.md) **PROMOTE** (`npm run nano:aj:freeze`) — COMPLETE+FROZEN; no Wave AK invent |

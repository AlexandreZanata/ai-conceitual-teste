...
| Wave AI4 H-FASTPUSH | [formal-hfastpush-fastpush.md](formal-hfastpush-fastpush.md) **PROMOTE** (`npm run nano:fastpush`) — gen hot 10.7&lt;FASTLIFT 11.6; next AI5 H-APPPUSH |

**Wave BG ACTIVE:** BG0 [SESSION PROMOTE](wave-bg-session.md) · BG1 [H-UNARYINT PROMOTE](formal-hunaryint-unaryint.md) · BG2 [H-SHIPPUB PROMOTE](formal-hshippub-shippub.md) · BG3 [H-FASTBG PROMOTE](formal-hfastbg-fastbg.md) · BG4 [H-CTXBG PROMOTE](formal-hctxbg-ctxbg.md) · BG5 [H-NANOGEN17 SKIP](formal-hnanogen17-nanogen17.md) · BG6 [BG-REAL-EVAL PROMOTE](wave-bg-real-eval.md) · BG7 [BG-REPORT PROMOTE](wave-bg-summary.md) (`npm run nano:bg:report`) · [paper-lab-wave-bg.md](paper-lab-wave-bg.md); next BG8 BG-FREEZE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.
**Wave BF COMPLETE + FROZEN:** BF0 [SESSION PROMOTE](wave-bf-session.md) (`npm run nano:bf:session`) · BF1 [H-PREDINT PROMOTE](formal-hpredint-predint.md) (`npm run nano:predint`) · BF2 [H-SHIPUSE2 PROMOTE](formal-hshipuse2-shipuse2.md) (`npm run nano:shipuse2`) · BF3 [H-FASTBF PROMOTE](formal-hfastbf-fastbf.md) (`npm run nano:fastbf`) · BF4 [H-CTXBF PROMOTE](formal-hctxbf-ctxbf.md) (`npm run nano:ctxbf`) · BF5 [H-NANOGEN16 SKIP](formal-hnanogen16-nanogen16.md) (`npm run nano:nanogen16`) · BF6 [BF-REAL-EVAL PROMOTE](wave-bf-real-eval.md) (`npm run nano:bf:real-eval`) — battery 16/16 · BF7 [BF-REPORT PROMOTE](wave-bf-summary.md) (`npm run nano:bf:report`) · [paper-lab-wave-bf.md](paper-lab-wave-bf.md); BF8 [BF-FREEZE PROMOTE](bf-freeze.md) (`npm run nano:bf:freeze`) · [formal-habffreeze-bf-freeze.md](formal-habffreeze-bf-freeze.md) — ship **AF + AQ + AS trust + ablated DECODE (STRICT)**; H-NANOGEN16 SKIP (NANOGEN6·7 HOLD · NANOGEN8…15 DEFER stand); ≤5M stays; do not invent Wave BG.
**Wave BE COMPLETE + FROZEN:** BE0 [SESSION PROMOTE](wave-be-session.md) (`npm run nano:be:session`) · BE1 [H-COMPINT PROMOTE](formal-hcompint-compint.md) (`npm run nano:compint`) · BE2 [H-SHIPUSE PROMOTE](formal-hshipuse-shipuse.md) (`npm run nano:shipuse`) · BE3 [H-FASTBE PROMOTE](formal-hfastbe-fastbe.md) (`npm run nano:fastbe`) · BE4 [H-CTXBE PROMOTE](formal-hctxbe-ctxbe.md) (`npm run nano:ctxbe`) · BE5 [H-NANOGEN15 DEFER](formal-hnanogen15-nanogen15.md) (`npm run nano:nanogen15`) · BE6 [BE-REAL-EVAL PROMOTE](wave-be-real-eval.md) (`npm run nano:be:real-eval`) — battery 15/15 · BE7 [BE-REPORT PROMOTE](wave-be-summary.md) (`npm run nano:be:report`) · [paper-lab-wave-be.md](paper-lab-wave-be.md); BE8 [BE-FREEZE PROMOTE](be-freeze.md) (`npm run nano:be:freeze`) · [formal-habefreeze-be-freeze.md](formal-habefreeze-be-freeze.md) — ship **AF + AQ + AS trust + ablated DECODE (STRICT)**; H-NANOGEN15 DEFER (NANOGEN6·7 HOLD · NANOGEN8…14 DEFER stand); ≤5M stays; do not invent Wave BF.
**Wave BD COMPLETE + FROZEN:** BD0 [SESSION PROMOTE](wave-bd-session.md) (`npm run nano:bd:session`) · BD1 [H-SEMINT PROMOTE](formal-hsemint-semint.md) (`npm run nano:semint`) · BD2 [H-FASTGAIN PROMOTE](formal-hfastgain-fastgain.md) (`npm run nano:bd:fastgain`) · BD3 [H-CTXGAIN PROMOTE](formal-hctxgain-ctxgain.md) (`npm run nano:bd:ctxgain`) · BD4 [H-NANOGEN14 DEFER](formal-hnanogen14-nanogen14.md) (`npm run nano:nanogen14`) · BD5 [BD-REAL-EVAL PROMOTE](wave-bd-real-eval.md) (`npm run nano:bd:real-eval`) — battery 14/14 · BD6 [BD-REPORT PROMOTE](wave-bd-summary.md) (`npm run nano:bd:report`) · [paper-lab-wave-bd.md](paper-lab-wave-bd.md); BD7 [BD-FREEZE PROMOTE](bd-freeze.md) (`npm run nano:bd:freeze`) · [formal-habdfreeze-bd-freeze.md](formal-habdfreeze-bd-freeze.md) — ship **AF + AQ + AS trust + ablated DECODE (STRICT)**; H-NANOGEN14 DEFER (NANOGEN6·7 HOLD · NANOGEN8·9·10·11·12·13 DEFER stand); ≤5M stays; do not invent Wave BE.
...
| Wave AZ1 H-PRODGEN | [formal-hprodgen-prodgen.md](formal-hprodgen-prodgen.md) **PROMOTE** (`npm run nano:prodgen`) — held-out FH **0**/12 · over-refuse miss **0**/3 · named hold **0**/12 · modes 4/4 |
| Wave AZ2 H-SHIPAZ | [formal-hshipaz-shipaz.md](formal-hshipaz-shipaz.md) **PROMOTE** (`npm run nano:shipaz`) — modes+content · held-out ABSTAIN · over-refuse LOOKUP · no unlabeled |
| Wave AZ3 H-NANOGEN10 | [formal-hnanogen10-nanogen10.md](formal-hnanogen10-nanogen10.md) **DEFER** (`npm run nano:nanogen10`) — gen stance defer · CAPCHECK closed · not NANOGEN9 rename · true_continue unmet |
| Wave AZ4 AZ-REAL-EVAL | [wave-az-real-eval.md](wave-az-real-eval.md) **PROMOTE** (`npm run nano:az:real-eval`) — battery 9/9 · gen locked (AZ3 DEFER) · held-out ABSTAIN · over-refuse LOOKUP · prod=eval |
| Wave AZ5 AZ-REPORT | [wave-az-summary.md](wave-az-summary.md) · [paper-lab-wave-az.md](paper-lab-wave-az.md) **PROMOTE** (`npm run nano:az:report`) — anti-FP · NANOGEN6/7 HOLD · NANOGEN8·9 DEFER cited · gen DEFER |
| Wave AZ6 AZ-FREEZE | [az-freeze.md](az-freeze.md) · [formal-hazfreeze-az-freeze.md](formal-hazfreeze-az-freeze.md) **PROMOTE** (`npm run nano:az:freeze`) — COMPLETE+FROZEN; H-NANOGEN10 DEFER; Wave BA reopened via lab-book |
| Wave BA0 SESSION | [wave-ba-session.md](wave-ba-session.md) **PROMOTE** (`npm run nano:ba:session`) — BA-FOREVER N≥15 · pow·mod·max·sort·len · AZ hold · §1 scoreboard · ctx/speed baselines · gen stance **defer** (H-NANOGEN11 · M1|M2|M3) · true-eval |
| Wave BA5 BA-REAL-EVAL | [wave-ba-real-eval.md](wave-ba-real-eval.md) **PROMOTE** (`npm run nano:ba:real-eval`) — battery 10/10 · gen locked (BA4 DEFER) |
| Wave BA6 BA-REPORT | [wave-ba-summary.md](wave-ba-summary.md) · [paper-lab-wave-ba.md](paper-lab-wave-ba.md) **PROMOTE** (`npm run nano:ba:report`) — anti-FP · BA4 DEFER · NANOGEN6/7 HOLD · NANOGEN8·9·10 DEFER cited |
| Wave BA7 BA-FREEZE | [ba-freeze.md](ba-freeze.md) · [formal-habfreeze-ba-freeze.md](formal-habfreeze-ba-freeze.md) **PROMOTE** (`npm run nano:ba:freeze`) — COMPLETE+FROZEN; H-NANOGEN11 DEFER; Wave BB reopened via lab-book |
| Wave BB0 SESSION | [wave-bb-session.md](wave-bb-session.md) **PROMOTE** (`npm run nano:bb:session`) — BB-FOREVER N≥15 · min·xor·absdiff·and·or · BA/AZ hold · §1 scoreboard · ctx/speed baselines · gen stance **defer** (H-NANOGEN12 · M1|M2|M3) · true-eval |
| Wave BB5 BB-REAL-EVAL | [wave-bb-real-eval.md](wave-bb-real-eval.md) **PROMOTE** (`npm run nano:bb:real-eval`) — battery 12/12 · gen locked (BB4 DEFER) |
| Wave BB6 BB-REPORT | [wave-bb-summary.md](wave-bb-summary.md) · [paper-lab-wave-bb.md](paper-lab-wave-bb.md) **PROMOTE** (`npm run nano:bb:report`) — anti-FP · BB4 DEFER · NANOGEN6/7 HOLD · NANOGEN8·9·10·11 DEFER cited |
| Wave BB7 BB-FREEZE | [bb-freeze.md](bb-freeze.md) · [formal-habbfreeze-bb-freeze.md](formal-habbfreeze-bb-freeze.md) **PROMOTE** (`npm run nano:bb:freeze`) — COMPLETE+FROZEN; H-NANOGEN12 DEFER; Wave BC reopened via lab-book |
| Wave BC0 SESSION | [wave-bc-session.md](wave-bc-session.md) **PROMOTE** (`npm run nano:bc:session`) — BC-FOREVER N≥18 · floordiv·neg·gcd·lshift·rshift·nand · BA/BB/AZ hold · §1 scoreboard · ctx/speed baselines · gen stance **defer** (H-NANOGEN13 · M1|M2|M3) · true-eval |
| Wave BC5 BC-REAL-EVAL | [wave-bc-real-eval.md](wave-bc-real-eval.md) **PROMOTE** (`npm run nano:bc:real-eval`) — battery 13/13 · gen locked (BC4 DEFER) |
| Wave BC6 BC-REPORT | [wave-bc-summary.md](wave-bc-summary.md) · [paper-lab-wave-bc.md](paper-lab-wave-bc.md) **PROMOTE** (`npm run nano:bc:report`) — anti-FP · BC4 DEFER · NANOGEN6/7 HOLD · NANOGEN8·9·10·11·12 DEFER cited |
| Wave BC7 BC-FREEZE | [bc-freeze.md](bc-freeze.md) · [formal-habcfreeze-bc-freeze.md](formal-habcfreeze-bc-freeze.md) **PROMOTE** (`npm run nano:bc:freeze`) — COMPLETE+FROZEN; H-NANOGEN13 DEFER; Wave BD reopened via lab-book |
| Wave BD0 SESSION | [wave-bd-session.md](wave-bd-session.md) **PROMOTE** (`npm run nano:bd:session`) — BD-FOREVER N≥12 · reverse≠f-string · mul≠add · wrong-bank · BA/BB/BC/AZ hold · §1 scoreboard · ctx/speed baselines · gen stance **defer** (H-NANOGEN14 · M1|M2|M3) · true-eval |
| Wave BD5 BD-REAL-EVAL | [wave-bd-real-eval.md](wave-bd-real-eval.md) **PROMOTE** (`npm run nano:bd:real-eval`) — battery 14/14 · gen locked (BD4 DEFER) |
| Wave BD6 BD-REPORT | [wave-bd-summary.md](wave-bd-summary.md) · [paper-lab-wave-bd.md](paper-lab-wave-bd.md) **PROMOTE** (`npm run nano:bd:report`) — anti-FP · BD4 DEFER · NANOGEN6/7 HOLD · NANOGEN8·9·10·11·12·13 DEFER cited |
| Wave BD7 BD-FREEZE | [bd-freeze.md](bd-freeze.md) · [formal-habdfreeze-bd-freeze.md](formal-habdfreeze-bd-freeze.md) **PROMOTE** (`npm run nano:bd:freeze`) — COMPLETE+FROZEN; H-NANOGEN14 DEFER; Wave BE reopened via lab-book |
| Wave BE0 SESSION | [wave-be-session.md](wave-be-session.md) **PROMOTE** (`npm run nano:be:session`) — BE-FOREVER N≥12 · str→int≠add · type/schema · BA…BD/AZ hold · Track A util · §1 scoreboard · ctx/speed baselines · gen stance **defer once** (H-NANOGEN15 · M1|M2|M3) · true-eval |
| Wave BF1 H-PREDINT | [formal-hpredint-predint.md](formal-hpredint-predint.md) **PROMOTE** (`npm run nano:predint`) — BF-FOREVER FH 0 · BA…BE/AZ hold · live FP 0 |
| Wave BF2 H-SHIPUSE2 | [formal-hshipuse2-shipuse2.md](formal-hshipuse2-shipuse2.md) **PROMOTE** (`npm run nano:shipuse2`) — Track A+ deepen · H-SHIPUSE hold |
| Wave BF3 H-FASTBF | [formal-hfastbf-fastbf.md](formal-hfastbf-fastbf.md) **PROMOTE** (`npm run nano:fastbf`) — p99_regress=False · BF FH 0 · live FP 0 |
| Wave BF6 BF-REAL-EVAL | [wave-bf-real-eval.md](wave-bf-real-eval.md) **PROMOTE** (`npm run nano:bf:real-eval`) — battery 16/16 · gen locked (BF5 SKIP) |
| Wave BF7 BF-REPORT | [wave-bf-summary.md](wave-bf-summary.md) · [paper-lab-wave-bf.md](paper-lab-wave-bf.md) **PROMOTE** (`npm run nano:bf:report`) — anti-FP · util · BF5 SKIP · NANOGEN6/7 HOLD · NANOGEN8…15 DEFER cited |
| Wave BF8 BF-FREEZE | [bf-freeze.md](bf-freeze.md) · [formal-habffreeze-bf-freeze.md](formal-habffreeze-bf-freeze.md) **PROMOTE** (`npm run nano:bf:freeze`) — COMPLETE+FROZEN; H-NANOGEN16 SKIP; Wave BG reopened via lab-book |
| Wave BG0 SESSION | [wave-bg-session.md](wave-bg-session.md) **PROMOTE** (`npm run nano:bg:session`) — BG-FOREVER N≥12 · abs≠add · factorial≠add · upper≠f-string · all-truthy≠clear · BA…BF/AZ hold · Track A++ util · §1 scoreboard · ctx/speed baselines · gen stance **SKIP** (no NANOGEN17 without method plan) · true-eval |
| Wave BG1 H-UNARYINT | [formal-hunaryint-unaryint.md](formal-hunaryint-unaryint.md) **PROMOTE** (`npm run nano:unaryint`) — BG-FOREVER FH 0 · BA…BF/AZ hold · live FP 0 |
| Wave BG2 H-SHIPPUB | [formal-hshippub-shippub.md](formal-hshippub-shippub.md) **PROMOTE** (`npm run nano:shippub`) — Track A++ deepen · H-SHIPUSE2 hold · paper/arXiv sync |
| Wave BG3 H-FASTBG | [formal-hfastbg-fastbg.md](formal-hfastbg-fastbg.md) **PROMOTE** (`npm run nano:fastbg`) — p99_regress=False · BG FH 0 · live FP 0 |
| Wave BG6 BG-REAL-EVAL | [wave-bg-real-eval.md](wave-bg-real-eval.md) **PROMOTE** (`npm run nano:bg:real-eval`) — battery 17/17 · gen locked (BG5 SKIP) |
| Wave BG7 BG-REPORT | [wave-bg-summary.md](wave-bg-summary.md) · [paper-lab-wave-bg.md](paper-lab-wave-bg.md) **PROMOTE** (`npm run nano:bg:report`) — anti-FP · util · BG5 SKIP · NANOGEN6/7 HOLD · NANOGEN8…15 DEFER · NANOGEN16 SKIP · NANOGEN17 SKIP cited |
| Wave BG5 H-NANOGEN17 | [formal-hnanogen17-nanogen17.md](formal-hnanogen17-nanogen17.md) **SKIP** (`npm run nano:nanogen17`) — gen SKIP stop rule · CAPCHECK closed · not empty DEFER letter |
| Wave BG4 H-CTXBG | [formal-hctxbg-ctxbg.md](formal-hctxbg-ctxbg.md) **PROMOTE** (`npm run nano:ctxbg`) — ctx 5/5 · BG FH 0 · live FP 0 |
| Wave BF5 H-NANOGEN16 | [formal-hnanogen16-nanogen16.md](formal-hnanogen16-nanogen16.md) **SKIP** (`npm run nano:nanogen16`) — gen SKIP stop rule · CAPCHECK closed · not empty DEFER letter |
| Wave BF4 H-CTXBF | [formal-hctxbf-ctxbf.md](formal-hctxbf-ctxbf.md) **PROMOTE** (`npm run nano:ctxbf`) — ctx 5/5 · BF FH 0 · live FP 0 |
| Wave BE1 H-COMPINT | [formal-hcompint-compint.md](formal-hcompint-compint.md) **PROMOTE** (`npm run nano:compint`) — BE FH 0 · BA…BD/AZ hold · live FP 0 |
| Wave BE2 H-SHIPUSE | [formal-hshipuse-shipuse.md](formal-hshipuse-shipuse.md) **PROMOTE** (`npm run nano:shipuse`) — Track A demo + operator + paper |
| Wave BE3 H-FASTBE | [formal-hfastbe-fastbe.md](formal-hfastbe-fastbe.md) **PROMOTE** (`npm run nano:fastbe`) — p99_regress=False · BE FH 0 · live FP 0 |
| Wave BE6 BE-REAL-EVAL | [wave-be-real-eval.md](wave-be-real-eval.md) **PROMOTE** (`npm run nano:be:real-eval`) — battery 15/15 · gen locked (BE5 DEFER) |
| Wave BE7 BE-REPORT | [wave-be-summary.md](wave-be-summary.md) · [paper-lab-wave-be.md](paper-lab-wave-be.md) **PROMOTE** (`npm run nano:be:report`) — anti-FP · util · BE5 DEFER · NANOGEN6/7 HOLD · NANOGEN8…15 DEFER cited |
| Wave BE8 BE-FREEZE | [be-freeze.md](be-freeze.md) · [formal-habefreeze-be-freeze.md](formal-habefreeze-be-freeze.md) **PROMOTE** (`npm run nano:be:freeze`) — COMPLETE+FROZEN; H-NANOGEN15 DEFER; Wave BF reopened via lab-book |
| Wave BF0 SESSION | [wave-bf-session.md](wave-bf-session.md) **PROMOTE** (`npm run nano:bf:session`) — BF-FOREVER N≥12 · even≠add · predicate/schema · BA…BE/AZ hold · Track A+ util · §1 scoreboard · ctx/speed baselines · gen stance **SKIP** (no NANOGEN16 without method plan) · true-eval |
| Wave BE5 H-NANOGEN15 | [formal-hnanogen15-nanogen15.md](formal-hnanogen15-nanogen15.md) **DEFER** (`npm run nano:nanogen15`) — gen stance defer once · CAPCHECK closed · not NANOGEN14 rename |
| Wave BE4 H-CTXBE | [formal-hctxbe-ctxbe.md](formal-hctxbe-ctxbe.md) **PROMOTE** (`npm run nano:ctxbe`) — ctx_ok 5/5 · BE FH 0 · live FP 0 |
| Wave BD4 H-NANOGEN14 | [formal-hnanogen14-nanogen14.md](formal-hnanogen14-nanogen14.md) **DEFER** (`npm run nano:nanogen14`) — gen stance defer · CAPCHECK closed · not NANOGEN13 rename |
| Wave BD3 H-CTXGAIN | [formal-hctxgain-ctxgain.md](formal-hctxgain-ctxgain.md) **PROMOTE** (`npm run nano:bd:ctxgain`) — ctx 5/5 · BD FH 0 · BC FH 0 · live FP 0 (≠ AH `nano:ctxlift` · ≠ BC `nano:bc:ctxlift2`) |
| Wave BD2 H-FASTGAIN | [formal-hfastgain-fastgain.md](formal-hfastgain-fastgain.md) **PROMOTE** (`npm run nano:bd:fastgain`) — p99_regress=False · BD FH 0 · BC FH 0 · live FP 0 (≠ AH `nano:fastlift` · ≠ BC `nano:bc:fastlift`) |
| Wave BD1 H-SEMINT | [formal-hsemint-semint.md](formal-hsemint-semint.md) **PROMOTE** (`npm run nano:semint`) — BD FH 0 · BA hold 0 · BC hold 0 · AZ hold 0 · live FP 0 |
| Wave BC4 H-NANOGEN13 | [formal-hnanogen13-nanogen13.md](formal-hnanogen13-nanogen13.md) **DEFER** (`npm run nano:nanogen13`) — gen stance defer · CAPCHECK closed · not NANOGEN12 rename |
| Wave BC3 H-CTXLIFT2 | [formal-hctxlift2-ctxlift2.md](formal-hctxlift2-ctxlift2.md) **PROMOTE** (`npm run nano:bc:ctxlift2`) — ctx 5/5 · BC FH 0 · BB FH 0 · live FP 0 (≠ AH `nano:ctxlift` · ≠ BB `nano:bb:ctxhold`) |
| Wave BC2 H-FASTLIFT | [formal-hfastlift-bc2.md](formal-hfastlift-bc2.md) **PROMOTE** (`npm run nano:bc:fastlift`) — p99_regress=False · BC FH 0 · BB FH 0 · live FP 0 (≠ AH `nano:fastlift` · ≠ BB `nano:bb:fasthold`) |
| Wave BC1 H-OPSFAM | [formal-hopsfam-opsfam.md](formal-hopsfam-opsfam.md) **PROMOTE** (`npm run nano:opsfam`) — BC FH 0 · BA hold 0 · AZ hold 0 · live FP 0 |
| Wave BB4 H-NANOGEN12 | [formal-hnanogen12-nanogen12.md](formal-hnanogen12-nanogen12.md) **DEFER** (`npm run nano:nanogen12`) — gen stance defer · CAPCHECK closed · not NANOGEN11 rename |
| Wave BB3 H-CTXHOLD | [formal-hctxhold-ctxhold.md](formal-hctxhold-ctxhold.md) **PROMOTE** (`npm run nano:bb:ctxhold`) — ctx 5/5 · BB FH 0 · BA FH 0 · live FP 0 (≠ BA `nano:ba:ctxreal2` · ≠ AG `nano:ctxreal`) |
| Wave BB2 H-FASTHOLD | [formal-hfasthold-fasthold.md](formal-hfasthold-fasthold.md) **PROMOTE** (`npm run nano:bb:fasthold`) — p99_regress=False · BB FH 0 · BA FH 0 · live FP 0 (≠ BA `nano:ba:fastreal` · ≠ AG `nano:fastreal`) |
| Wave BB1 H-INTENTGEN | [formal-hintentgen-intentgen.md](formal-hintentgen-intentgen.md) **PROMOTE** (`npm run nano:intentgen`) — BB FH 0 · BA hold 0 · AZ hold 0 · live FP 0 |
| Wave BA4 H-NANOGEN11 | [formal-hnanogen11-nanogen11.md](formal-hnanogen11-nanogen11.md) **DEFER** (`npm run nano:nanogen11`) — gen stance defer · CAPCHECK closed · not NANOGEN10 rename |
| Wave BA3 H-CTXREAL2 | [formal-hctxreal2-ctxreal2.md](formal-hctxreal2-ctxreal2.md) **PROMOTE** (`npm run nano:ba:ctxreal2`) — ctx 5/5 · forever FH 0 · live FP 0 (≠ AG `nano:ctxreal` archive) |
...
| Wave BA1 H-REALGAIN | [formal-hrealgain-realgain.md](formal-hrealgain-realgain.md) **PROMOTE** (`npm run nano:realgain`) — forever FH 0 · AZ hold 0 · over-refuse miss 0 · live FP 0 |
...
| Use | Command |
|-----|----------|
| Known-ask HITL | `npm run nano:z:ask -- --wrap --semwrap --question "…"` |
| Modes | always `LOOKUP` · `PEAK` · `DECODE` · `ABSTAIN` |
| BE residual smoke | convert string s → **ABSTAIN** (not LOOKUP add) |
| Ship claim | AF packaged + AQ + AS + STRICT ablated DECODE — not unlabeled open chat · not TAC unlocked |
...
| Known-ask HITL | `npm run nano:z:ask -- --wrap --semwrap --question "…"` |
| Modes | always `LOOKUP` · `PEAK` · `DECODE` · `ABSTAIN` |
| H-PREDINT hold | even / predicate ask → **ABSTAIN** (not LOOKUP add) |
...
| Known-ask HITL | `npm run nano:z:ask -- --wrap --semwrap --question "…"` |
| Modes | always `LOOKUP` · `PEAK` · `DECODE` · `ABSTAIN` |
| H-UNARYINT hold | abs / factorial / uppercase → **ABSTAIN** (not wrong LOOKUP) |

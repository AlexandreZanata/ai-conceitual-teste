...
**Wave AN OPEN:** AN0 [SESSION PROMOTE](wave-an-session.md) (`npm run nano:an:session`) — freeze 10 held-out ≠ AB…AM · AN1 [H-GENEDGE HOLD](formal-hgenedge-genedge.md) (`npm run nano:genedge`) — ablated gen 4.0; peak_only_lift · AN2 [H-CTXEDGE PROMOTE](formal-hctxedge-ctxedge.md) (`npm run nano:ctxedge`) — L_eff 242448 · AN3 [H-SMARTEDGE PROMOTE](formal-hsmartedge-smartedge.md) (`npm run nano:smartedge`) — cite+gen 9.0/9.0; next AN4 H-FASTEDGE.

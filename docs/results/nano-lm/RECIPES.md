...
**Wave AW ACTIVE:** AW0 [SESSION PROMOTE](wave-aw-session.md) (`npm run nano:aw:session`) · AW1 [H-PRODKEEP PROMOTE](formal-hprodkeep-prodkeep.md) (`npm run nano:prodkeep`) · AW2 [H-SHIPKEEP PROMOTE](formal-hshipkeep-shipkeep.md) (`npm run nano:shipkeep`); next AW3 H-NANOGEN7; ship **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

...
| Wave AS10 AS-FREEZE | [as-freeze.md](as-freeze.md) · [formal-hasfreeze-as-freeze.md](formal-hasfreeze-as-freeze.md) **PROMOTE** (`npm run nano:as:freeze`) — COMPLETE+FROZEN; no Wave AT invent |

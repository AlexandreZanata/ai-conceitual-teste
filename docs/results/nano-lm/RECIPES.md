...
**Wave AL OPEN:** AL0 [SESSION PROMOTE](wave-al-session.md) (`npm run nano:al:session`) · AL1 [H-GENFRESH HOLD](formal-hgenfresh-genfresh.md) (`npm run nano:genfresh`) · AL2 [H-CTXFRESH PROMOTE](formal-hctxfresh-ctxfresh.md) (`npm run nano:ctxfresh`) — L_eff 200344; next **AL3 H-SMARTFRESH**; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AM.

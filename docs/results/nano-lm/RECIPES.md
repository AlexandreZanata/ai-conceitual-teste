...
| Wave AI7 AI-REPORT | [wave-ai-summary.md](wave-ai-summary.md) **PROMOTE** (`npm run nano:ai:report`) — public summary + [paper-lab-wave-ai.md](paper-lab-wave-ai.md); next AI8 AI-FREEZE |

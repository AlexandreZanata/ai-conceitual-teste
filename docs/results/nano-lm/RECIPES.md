...
**Wave AK OPEN:** AK0 [SESSION PROMOTE](wave-ak-session.md) (`npm run nano:ak:session`) · AK1 [H-GENTRUE HOLD](formal-hgentrue-gentrue.md) (`npm run nano:gentrue`) — ablated gen 4.0 / peak_only_lift; next **AK2 H-CTXMORE**; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AL.

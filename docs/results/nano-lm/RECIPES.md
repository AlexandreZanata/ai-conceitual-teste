...
**Wave AT OPEN:** AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) — PRODREG suite · SHIPAPP charter · NANOGEN4 snippet-prefix hyp · real-eval battery; next AT1 H-PRODREG.

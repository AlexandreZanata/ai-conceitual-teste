...
| Wave AV5 AV-REPORT | [wave-av-summary.md](wave-av-summary.md) · [paper-lab-wave-av.md](paper-lab-wave-av.md) **PROMOTE** (`npm run nano:av:report`) — anti-FP + real-eval · RESEARCH_COMPLETE |

...
**Wave AN OPEN:** AN0 [SESSION PROMOTE](wave-an-session.md) (`npm run nano:an:session`) — freeze 10 held-out ≠ AB…AM · AN1 [H-GENEDGE HOLD](formal-hgenedge-genedge.md) (`npm run nano:genedge`) — ablated gen 4.0; peak_only_lift; next AN2 H-CTXEDGE.

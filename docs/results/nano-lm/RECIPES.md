...
| Wave AL8 AL-FREEZE | [al-freeze.md](al-freeze.md) · [formal-halfreeze-al-freeze.md](formal-halfreeze-al-freeze.md) **PROMOTE** (`npm run nano:al:freeze`) — COMPLETE+FROZEN; no Wave AM without reopen |

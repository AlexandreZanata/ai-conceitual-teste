...
| Wave AR8 AR-FREEZE | [ar-freeze.md](ar-freeze.md) · [formal-harfreeze-ar-freeze.md](formal-harfreeze-ar-freeze.md) **PROMOTE** (`npm run nano:ar:freeze`) — COMPLETE+FROZEN; no Wave AS invent |

...
**Wave AW ACTIVE:** AW0 [SESSION PROMOTE](wave-aw-session.md) (`npm run nano:aw:session`) — product-keep · pressure-para · NANOGEN7 TAC; next AW1 H-PRODKEEP; ship **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

...
**Wave AT OPEN:** AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) — PRODREG suite · SHIPAPP charter · NANOGEN4 snippet-prefix hyp · real-eval battery; AT1 [H-PRODREG PROMOTE](formal-hprodreg-prodreg.md) (`npm run nano:prodreg`) — Caminho A bars hold; AT2 [H-SHIPAPP PROMOTE](formal-hshipapp-shipapp.md) (`npm run nano:shipapp`) — ask·apps·ship/demo 4/4; AT3 [H-NANOGEN4 PROMOTE](formal-hnanogen4-nanogen4.md) (`npm run nano:nanogen4`) — ablated **5.5**; next AT4 AT-REAL-EVAL.

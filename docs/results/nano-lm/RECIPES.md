...
| Wave AQ0 SESSION | [wave-aq-session.md](wave-aq-session.md) **PROMOTE** (`npm run nano:aq:session`) — paraphrase-20 · adversary-20 · latency triad · KB holes · mode charter; next AQ1 H-PARAHIT |

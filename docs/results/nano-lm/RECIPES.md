...
| Wave AX6 AX-FREEZE | [ax-freeze.md](ax-freeze.md) · [formal-haxfreeze-ax-freeze.md](formal-haxfreeze-ax-freeze.md) **PROMOTE** (`npm run nano:ax:freeze`) — COMPLETE+FROZEN; H-NANOGEN8 DEFER; do not invent Wave AY |

...
| Wave AQ2 H-ADVFP | [formal-hadvfp-advfp.md](formal-hadvfp-advfp.md) **PROMOTE** (`npm run nano:advfp`) — false-hit 0/20; SEMWRAP contrast reject; next AQ3 H-LATP |

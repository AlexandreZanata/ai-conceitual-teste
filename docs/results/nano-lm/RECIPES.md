...
| Wave AQ7 AQ-PRODUCT-HITL | [wave-aq-product-hitl.md](wave-aq-product-hitl.md) **PROMOTE** (`npm run nano:aq:product-hitl`) — pillars+apps; gen claim locked; next AQ8 AQ-REPORT |

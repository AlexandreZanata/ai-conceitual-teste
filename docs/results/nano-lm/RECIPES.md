...
**Wave AW ACTIVE:** AW0 [SESSION PROMOTE](wave-aw-session.md) (`npm run nano:aw:session`) · AW1 [H-PRODKEEP PROMOTE](formal-hprodkeep-prodkeep.md) (`npm run nano:prodkeep`) — pressure-para **0.95**/20; next AW2 H-SHIPKEEP; ship **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

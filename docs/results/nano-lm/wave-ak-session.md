...
Next: **AK1 H-GENTRUE** — **DONE HOLD** → [formal-hgentrue-gentrue.md](formal-hgentrue-gentrue.md). **AK2 H-CTXMORE** — **DONE PROMOTE** → [formal-hctxmore-ctxmore.md](formal-hctxmore-ctxmore.md). **AK3 H-SMARTMORE** — **DONE PROMOTE** → [formal-hsmartmore-smartmore.md](formal-hsmartmore-smartmore.md). **AK4 H-FASTMORE** — **DONE PROMOTE** → [formal-hfastmore-fastmore.md](formal-hfastmore-fastmore.md). **AK5 H-APPMORE** — **DONE PROMOTE** → [formal-happmore-appmore.md](formal-happmore-appmore.md). **AK6 AK-HITL-10** — **DONE PROMOTE** → [wave-ak-hitl.md](wave-ak-hitl.md). Next: **AK7 AK-REPORT**.

...
Z1 HITL-10 **DONE (FAIL)** — [wave-z-hitl-z1.md](wave-z-hitl-z1.md). Z2 WRAP **PASS** — [wave-z-hitl-z2.md](wave-z-hitl-z2.md). Z3 H-ZERR **PROMOTE** — [wave-z-zerr.md](wave-z-zerr.md). Next: **Z4**.

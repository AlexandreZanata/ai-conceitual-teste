...
**Reopen (2026-07-26):** Wave AF opened via `.local/pesquisa.md` §5 and is now **COMPLETE + FROZEN** — [wave-af-summary.md](wave-af-summary.md) · [af-freeze.md](af-freeze.md) · [paper-lab-wave-af.md](paper-lab-wave-af.md). AE freeze outcomes stay locked.

# SHIPPUB — mode always visible (ask · apps · ship/demo)
...
| PEAK | **PEAK** | `mode=PEAK · wall_ms=0.1680 · n_new=14 · raw=PEAK_FAST+GENBASE` |
| ABSTAIN | **ABSTAIN** | `mode=ABSTAIN · wall_ms=486.0317 · n_new=64 · raw=NO_ANSWER` |
...
| ? | **ABSTAIN** | `mode=ABSTAIN · wall_ms=0.0000 · n_new=0 · raw=NO_ANSWER` |
| ? | **LOOKUP** | `mode=LOOKUP · wall_ms=0.0000 · n_new=0 · raw=WRAP_LOOKUP` |
| ? | **ABSTAIN** | `mode=ABSTAIN · wall_ms=475.1324 · n_new=64 · raw=NO_ANSWER` |

...
**Wave AQ OPEN** — AQ0 [SESSION PROMOTE](wave-aq-session.md) (`npm run nano:aq:session`) — paraphrase-20 · adversary-20 · latency triad · KB holes · mode charter LOOKUP\|PEAK\|DECODE; next AQ1 H-PARAHIT; ship claim **AF packaged stack + AQ product layer**; ≤5M stays; do not invent Wave AR.

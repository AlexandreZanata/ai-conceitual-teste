...
**Wave BG ACTIVE** — BG0 [SESSION PROMOTE](wave-bg-session.md) · BG1 [H-UNARYINT PROMOTE](formal-hunaryint-unaryint.md) · BG2 [H-SHIPPUB PROMOTE](formal-hshippub-shippub.md) · BG3 [H-FASTBG PROMOTE](formal-hfastbg-fastbg.md) · BG4 [H-CTXBG PROMOTE](formal-hctxbg-ctxbg.md) (`npm run nano:ctxbg`) — ctx 5/5; next BG5 H-NANOGEN17/SKIP; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

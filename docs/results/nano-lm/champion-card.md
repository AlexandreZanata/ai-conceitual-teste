...
**Wave AR OPEN** — AR0 [SESSION PROMOTE](wave-ar-session.md) · AR1 [H-ABSTAIN PROMOTE](formal-habstain-abstain.md) · AR2 [H-SHIPDEMO PROMOTE](formal-hshipdemo-shipdemo.md) · AR3 [H-PARAEXT HOLD](formal-hparaext-paraext.md) · AR4 [H-ADVREG KILL](formal-hadvreg-advreg.md) · AR5 [H-NANOGEN2 HOLD](formal-hnanogen2-nanogen2.md) · AR6 [AR-DUAL-HITL HOLD](wave-ar-dual-hitl.md) (`npm run nano:ar:dual-hitl`) — soft PARAEXT/ADVREG · gen locked; next AR7 AR-REPORT; ship claim **AF packaged stack + AQ product layer**; ≤5M stays; do not invent Wave AS.

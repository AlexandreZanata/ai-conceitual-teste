...
**Wave AV ACTIVE** — AV0 [SESSION PROMOTE](wave-av-session.md) (`npm run nano:av:session`) · AV1 [H-PRODSHIP PROMOTE](formal-hprodship-prodship.md) (`npm run nano:prodship`) — external para · FH 0 · DECODE content debt closed; next AV2 H-SHIPUI2; ship remains AU lock until AV stage PROMOTE; ≤5M stays; do not invent Wave AW.

...
**Wave BC ACTIVE** — BC0 [SESSION PROMOTE](wave-bc-session.md) · BC1 [H-OPSFAM PROMOTE](formal-hopsfam-opsfam.md) · BC2 [H-FASTLIFT PROMOTE](formal-hfastlift-bc2.md) · BC3 [H-CTXLIFT2 PROMOTE](formal-hctxlift2-ctxlift2.md) · BC4 [H-NANOGEN13 DEFER](formal-hnanogen13-nanogen13.md) (`npm run nano:nanogen13`) — gen stance defer · not NANOGEN12 rename; next BC5 BC-REAL-EVAL; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

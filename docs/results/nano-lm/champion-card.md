...
**Wave BF ACTIVE** — BF0 [SESSION PROMOTE](wave-bf-session.md) · BF1 [H-PREDINT PROMOTE](formal-hpredint-predint.md) · BF2 [H-SHIPUSE2 PROMOTE](formal-hshipuse2-shipuse2.md) · BF3 [H-FASTBF PROMOTE](formal-hfastbf-fastbf.md) · BF4 [H-CTXBF PROMOTE](formal-hctxbf-ctxbf.md) · BF5 [H-NANOGEN16 SKIP](formal-hnanogen16-nanogen16.md) · BF6 [BF-REAL-EVAL PROMOTE](wave-bf-real-eval.md) · BF7 [BF-REPORT PROMOTE](wave-bf-summary.md) (`npm run nano:bf:report`) · [paper-lab-wave-bf.md](paper-lab-wave-bf.md); next BF8 BF-FREEZE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

...
**Wave BC ACTIVE** — BC0 [SESSION PROMOTE](wave-bc-session.md) · BC1 [H-OPSFAM PROMOTE](formal-hopsfam-opsfam.md) · BC2 [H-FASTLIFT PROMOTE](formal-hfastlift-bc2.md) · BC3 [H-CTXLIFT2 PROMOTE](formal-hctxlift2-ctxlift2.md) (`npm run nano:bc:ctxlift2`) — ctx 5/5; next BC4 H-NANOGEN13; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

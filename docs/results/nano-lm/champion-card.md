...
**Wave AS OPEN** — AS0–AS6 product trust **PROMOTE** · AS7 [H-NANOGEN3 HOLD](formal-hnanogen3-nanogen3.md) · AS8 [AS-DUAL-HITL PROMOTE](wave-as-dual-hitl.md) · AS9 [AS-REPORT PROMOTE](wave-as-summary.md) · [paper-lab-wave-as.md](paper-lab-wave-as.md) (`npm run nano:as:report`); next **AS10 AS-FREEZE**; ship remains **AF packaged stack + AQ product layer** (no generative claim).

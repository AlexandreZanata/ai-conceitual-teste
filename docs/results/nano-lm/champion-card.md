...
**Wave AD OPEN** — [wave-ad-session.md](wave-ad-session.md) · [formal-hhardpara-hardpara.md](formal-hhardpara-hardpara.md) · [formal-hcompose-compose.md](formal-hcompose-compose.md) (held-out ASK→EVAL→FIX; next H-ROUTEPLUS).

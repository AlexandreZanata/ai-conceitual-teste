...
**Wave AD OPEN** — [wave-ad-session.md](wave-ad-session.md) · [wave-ad-hitl.md](wave-ad-hitl.md) (final HITL **9.0**; next AD-REPORT). Formals: HARDPARA · COMPOSE · ROUTEPLUS · DEPLPLUS.

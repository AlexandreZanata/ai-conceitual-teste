...
**Wave AW ACTIVE** — AW0 [SESSION PROMOTE](wave-aw-session.md) (`npm run nano:aw:session`) — product-keep · pressure-para N≥20 ≠ AV/AU · NANOGEN7 TAC hyp · true-eval; next AW1 H-PRODKEEP; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

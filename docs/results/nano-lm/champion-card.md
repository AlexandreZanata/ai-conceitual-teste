...
**Wave AL OPEN** — AL0 [SESSION PROMOTE](wave-al-session.md) (`npm run nano:al:session`) · next **AL1 H-GENFRESH** — ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AM.

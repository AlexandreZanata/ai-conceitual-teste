...
**Wave AV ACTIVE** — AV0 [SESSION PROMOTE](wave-av-session.md) (`npm run nano:av:session`) — product-ship · external-para N≥20 ≠ AU · NANOGEN6 hyp (true continue; span-fallback ≠ gen) · real-eval; next AV1 H-PRODSHIP; ship remains AU lock until AV stage PROMOTE; ≤5M stays; do not invent Wave AW.

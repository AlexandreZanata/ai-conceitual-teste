...
**Wave BG ACTIVE** — BG0 [SESSION PROMOTE](wave-bg-session.md) (`npm run nano:bg:session`) — BG-FOREVER unary/transform anti-FP · BA…BF/AZ hold · Track A++ paper/util · §1 scoreboard · ctx/speed baselines · gen stance **SKIP** (no NANOGEN17 without method plan) · real-eval; next BG1 H-UNARYINT; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD · NANOGEN8…15 DEFER · NANOGEN16 SKIP; ≤5M stays.

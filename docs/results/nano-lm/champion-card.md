...
**Wave BA ACTIVE** — BA0 [SESSION PROMOTE](wave-ba-session.md) (`npm run nano:ba:session`) — BA-FOREVER anti-FP · AZ hold · §1 scoreboard · ctx/speed baselines · gen stance **defer** (H-NANOGEN11 · M1|M2|M3) · real-eval; next BA1 H-REALGAIN; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD · NANOGEN8·9·10 DEFER; ≤5M stays.

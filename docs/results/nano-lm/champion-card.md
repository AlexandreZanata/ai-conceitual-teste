...
**Wave BC ACTIVE** — BC0 [SESSION PROMOTE](wave-bc-session.md) (`npm run nano:bc:session`) — BC-FOREVER anti-FP · BA/BB/AZ hold · §1 scoreboard · ctx/speed baselines · gen stance **defer** (H-NANOGEN13 · M1|M2|M3) · real-eval; next BC1 H-OPSFAM; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD · NANOGEN8·9·10·11·12 DEFER; ≤5M stays.

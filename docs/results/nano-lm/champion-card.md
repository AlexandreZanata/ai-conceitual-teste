...
**Wave AZ ACTIVE** — AZ0 [SESSION PROMOTE](wave-az-session.md) (`npm run nano:az:session`) — held-out intent FP · over-refuse gold · PRODGEN charter · gen stance **defer** (H-NANOGEN10) · real-eval · AZ1 [H-PRODGEN PROMOTE](formal-hprodgen-prodgen.md) (`npm run nano:prodgen`) — held-out FH **0**; next AZ2 H-SHIPAZ; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD · NANOGEN8·9 DEFER; ≤5M stays.

...
**Wave AI OPEN** — AI0 [SESSION PROMOTE](wave-ai-session.md) (`npm run nano:ai:session`) · AI1 [H-GENPLUS HOLD](formal-hgenplus-genplus.md) (`npm run nano:genplus`) · next **AI1b H-CAPRENEG** (optional) or **AI2 H-CTXPUSH** (ship claim remains **AF packaged stack**).

...
**Wave AT OPEN** — AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) — PRODREG suite · SHIPAPP · NANOGEN4 hyp · real-eval; next AT1 H-PRODREG; ship **AF + AQ + AS trust path** (no gen claim until NANOGEN4); ≤5M stays; do not invent Wave AU.

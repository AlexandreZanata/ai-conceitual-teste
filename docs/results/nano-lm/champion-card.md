...
**Wave BA ACTIVE** — BA0 [SESSION PROMOTE](wave-ba-session.md) · BA1 [H-REALGAIN PROMOTE](formal-hrealgain-realgain.md) · BA2 [H-FASTREAL PROMOTE](formal-hfastreal-ba2.md) · BA3 [H-CTXREAL2 PROMOTE](formal-hctxreal2-ctxreal2.md) (`npm run nano:ba:ctxreal2`) — howto·cite·long content_ok; next BA4 H-NANOGEN11; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

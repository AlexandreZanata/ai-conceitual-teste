...
**Wave AS OPEN** — AS0 [SESSION PROMOTE](wave-as-session.md) (`npm run nano:as:session`) — ADVSAFE cite AR-ADVREG-01/05 · PARAEXT2 · ASKABSTAIN · SEMFIX · NANOGEN3 · metrics; next **AS1 H-ASKABSTAIN**.

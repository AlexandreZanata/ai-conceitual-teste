...
**Wave AD COMPLETE** (pending FREEZE) — [wave-ad-summary.md](wave-ad-summary.md) · [paper-lab-wave-ad.md](paper-lab-wave-ad.md) · [wave-ad-hitl.md](wave-ad-hitl.md) (HITL **9.0**; next AD-FREEZE).

...
**Wave AX ACTIVE** — AX0 [SESSION PROMOTE](wave-ax-session.md) (`npm run nano:ax:session`) — hard-natural · PRODNAT charter · gen stance **defer** · real-eval; next AX1 H-PRODNAT; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD; ≤5M stays.

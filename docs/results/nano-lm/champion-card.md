...
**Wave BF ACTIVE** — BF0 [SESSION PROMOTE](wave-bf-session.md) (`npm run nano:bf:session`) · BF1 [H-PREDINT PROMOTE](formal-hpredint-predint.md) (`npm run nano:predint`) — BF-FOREVER FH 0 · BA…BE/AZ hold; next BF2 H-SHIPUSE2; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

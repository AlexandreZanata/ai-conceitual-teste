...
**Wave AS OPEN** — AS0 [SESSION PROMOTE](wave-as-session.md) (`npm run nano:as:session`) · AS1 [H-ASKABSTAIN PROMOTE](formal-haskabstain-askabstain.md) (`npm run nano:askabstain`) — default ask OOD abstain 1.0 · FH 0; next **AS2 H-SEMFIX**.

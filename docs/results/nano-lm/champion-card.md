...
**Wave BE ACTIVE** — BE0 [SESSION PROMOTE](wave-be-session.md) · BE1 [H-COMPINT PROMOTE](formal-hcompint-compint.md) · BE2 [H-SHIPUSE PROMOTE](formal-hshipuse-shipuse.md) · BE3 [H-FASTBE PROMOTE](formal-hfastbe-fastbe.md) (`npm run nano:fastbe`) — p99_regress=False · BE FH 0; next BE4 H-CTXBE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

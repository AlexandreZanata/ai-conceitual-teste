...
**Wave BC ACTIVE** — BC0 [SESSION PROMOTE](wave-bc-session.md) · BC1 [H-OPSFAM PROMOTE](formal-hopsfam-opsfam.md) (`npm run nano:opsfam`) — BC FH 0 · BB hold 0; next BC2 H-FASTLIFT; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

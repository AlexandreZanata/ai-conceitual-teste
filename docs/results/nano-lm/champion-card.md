...
**Wave AT OPEN** — AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) · AT1 [H-PRODREG PROMOTE](formal-hprodreg-prodreg.md) (`npm run nano:prodreg`) — para **0.80** · FH **0** · modes 4/4; next AT2 H-SHIPAPP; ship **AF + AQ + AS trust path** (no gen claim until NANOGEN4); ≤5M stays; do not invent Wave AU.

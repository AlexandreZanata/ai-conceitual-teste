...
**Wave AE OPEN** — AE0 [SESSION PROMOTE](wave-ae-session.md) · AE1 [H-CTXMAX PROMOTE](formal-hctxmax-ctxmax.md) · AE2 [H-SMARTMAX PROMOTE](formal-hsmartmax-smartmax.md) · next **H-FASTMAX** (ship claim = AD stack until AE5).

...
**Wave AI OPEN** — AI0 [SESSION PROMOTE](wave-ai-session.md) · AI1 [H-GENPLUS HOLD](formal-hgenplus-genplus.md) · AI1b [H-CAPRENEG HOLD](formal-hcapreneg-capreneg.md) (`npm run nano:capreneg`) · **≤5M stays** · next **AI2 H-CTXPUSH** (ship claim remains **AF packaged stack**).

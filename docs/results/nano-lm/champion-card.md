...
**Wave BA ACTIVE** — BA0 [SESSION PROMOTE](wave-ba-session.md) · BA1 [H-REALGAIN PROMOTE](formal-hrealgain-realgain.md) · BA2 [H-FASTREAL PROMOTE](formal-hfastreal-ba2.md) (`npm run nano:ba:fastreal`) — prod p50/p99 + anti-FP hold; next BA3 H-CTXREAL2; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

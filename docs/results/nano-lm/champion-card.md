...
> Deploy: [RECIPES.md](RECIPES.md). Lab: `.local/pesquisa.md` (**Wave Y ACTIVE** — serve-cache **PROMOTE**; next H-PFB256).  
...
| 2 | **Code-smart serve** | **H-ABS-QPFB2** (+ **H-BEAMKV** / **H-TCACHE** / **H-SCORERAM**) | [PFB](formal-hpfb-pfb.md) · [PFB2](formal-hpfb2-pfb2.md) · [QPFB2](formal-hqpfb2-qpfb2.md) · [BPFB](formal-hbpfb-bpfb.md) · [GPFB4](formal-hgpfb4-gpfb4.md) · [BEAMKV](formal-hbeamkv-beamkv.md) · [TCACHE](formal-htcache-tcache.md) · [SCORERAM](formal-hscoreram-scoreram.md) |
...
**Wave Y ACTIVE** — [wave-y-summary.md](wave-y-summary.md) (serve-cache **PROMOTE**; next H-PFB256).

...
**Wave AQ OPEN** — AQ0 [SESSION PROMOTE](wave-aq-session.md) (`npm run nano:aq:session`) · AQ1 [H-PARAHIT PROMOTE](formal-hparahit-parahit.md) (`npm run nano:parahit`) — hit_rate 0.95 · false-hit 0; next AQ2 H-ADVFP; ship claim **AF packaged stack + AQ product layer**; ≤5M stays; do not invent Wave AR.

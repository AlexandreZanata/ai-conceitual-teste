...
**Wave AX ACTIVE** — AX0 [SESSION PROMOTE](wave-ax-session.md) (`npm run nano:ax:session`) — hard-natural · PRODNAT charter · gen stance **defer** · real-eval · AX1 [H-PRODNAT PROMOTE](formal-hprodnat-prodnat.md) (`npm run nano:prodnat`) — hard-natural **1.0**/18 (18/18) · FH **0**; next AX2 H-SHIPUX; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD; ≤5M stays.

...
**Wave AY ACTIVE** — AY0 [SESSION PROMOTE](wave-ay-session.md) (`npm run nano:ay:session`) — intent-adversary FP · PRODINT charter · gen stance **defer** (H-NANOGEN9) · real-eval · AY1 [H-PRODINT PROMOTE](formal-hprodint-prodint.md) (`npm run nano:prodint`) — intent FH **0** · AY2 [H-SHIPAY PROMOTE](formal-hshipay-shipay.md) (`npm run nano:shipay`) — modes+content · intent ABSTAIN · AY3 [H-NANOGEN9 DEFER](formal-hnanogen9-nanogen9.md) (`npm run nano:nanogen9`) — gen stance defer · CAPCHECK closed · not NANOGEN8 rename · AY4 [AY-REAL-EVAL PROMOTE](wave-ay-real-eval.md) (`npm run nano:ay:real-eval`) — battery 8/8 · gen locked (AY3 DEFER) · AY5 [AY-REPORT PROMOTE](wave-ay-summary.md) (`npm run nano:ay:report`) · [paper-lab-wave-ay.md](paper-lab-wave-ay.md); next AY6 AY-FREEZE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD · NANOGEN8 DEFER; ≤5M stays.

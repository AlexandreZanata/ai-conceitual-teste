...
**Wave AR OPEN** — AR0 [SESSION PROMOTE](wave-ar-session.md) (`npm run nano:ar:session`) · AR1 [H-ABSTAIN PROMOTE](formal-habstain-abstain.md) (`npm run nano:abstain`) · AR2 [H-SHIPDEMO PROMOTE](formal-hshipdemo-shipdemo.md) (`npm run nano:shipdemo`) · AR3 [H-PARAEXT HOLD](formal-hparaext-paraext.md) (`npm run nano:paraext`) — hit 0.65 · FH 0 · AR4 [H-ADVREG KILL](formal-hadvreg-advreg.md) (`npm run nano:advreg`) — FH 2/20 · SAFE≠quality; next AR5 H-NANOGEN2; ship claim **AF packaged stack + AQ product layer**; ≤5M stays; do not invent Wave AS.

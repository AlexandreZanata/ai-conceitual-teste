...
**Wave BB ACTIVE** — BB0 [SESSION PROMOTE](wave-bb-session.md) · BB1 [H-INTENTGEN PROMOTE](formal-hintentgen-intentgen.md) · BB2 [H-FASTHOLD PROMOTE](formal-hfasthold-fasthold.md) (`npm run nano:bb:fasthold`) — p99_regress=False · BB FH 0; next BB3 H-CTXHOLD; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

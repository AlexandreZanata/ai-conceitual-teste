...
**Wave BG ACTIVE** — BG0 [SESSION PROMOTE](wave-bg-session.md) (`npm run nano:bg:session`) · BG1 [H-UNARYINT PROMOTE](formal-hunaryint-unaryint.md) (`npm run nano:unaryint`) — BG-FOREVER FH 0 · BA…BF/AZ hold 0; next BG2 H-SHIPPUB; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

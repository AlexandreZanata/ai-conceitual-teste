...
**Wave BB ACTIVE** — BB0 [SESSION PROMOTE](wave-bb-session.md) · BB1 [H-INTENTGEN PROMOTE](formal-hintentgen-intentgen.md) · BB2 [H-FASTHOLD PROMOTE](formal-hfasthold-fasthold.md) · BB3 [H-CTXHOLD PROMOTE](formal-hctxhold-ctxhold.md) (`npm run nano:bb:ctxhold`) — ctx 5/5; next BB4 H-NANOGEN12; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

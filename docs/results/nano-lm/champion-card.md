...
**Wave AM OPEN** — AM0 [SESSION PROMOTE](wave-am-session.md) (`npm run nano:am:session`) · AM1 [H-GENTRUTH HOLD](formal-hgentruth-gentruth.md) (`npm run nano:gentruth`) · AM2 [H-CTXNEXT PROMOTE](formal-hctxnext-ctxnext.md) (`npm run nano:ctxnext`) — L_eff 213147 · AM3 [H-SMARTNEXT PROMOTE](formal-hsmartnext-smartnext.md) (`npm run nano:smartnext`) — cite+gen 9.0/9.0; next AM4 H-FASTNEXT.

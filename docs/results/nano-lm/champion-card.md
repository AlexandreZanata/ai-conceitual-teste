...
**Wave BA ACTIVE** — BA0 [SESSION PROMOTE](wave-ba-session.md) · BA1 [H-REALGAIN PROMOTE](formal-hrealgain-realgain.md) (`npm run nano:realgain`) — forever FH 0 · AZ hold 0; next BA2 H-FASTREAL; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

...
**Wave BC ACTIVE** — BC0 [SESSION PROMOTE](wave-bc-session.md) · BC1 [H-OPSFAM PROMOTE](formal-hopsfam-opsfam.md) · BC2 [H-FASTLIFT PROMOTE](formal-hfastlift-bc2.md) · BC3 [H-CTXLIFT2 PROMOTE](formal-hctxlift2-ctxlift2.md) · BC4 [H-NANOGEN13 DEFER](formal-hnanogen13-nanogen13.md) · BC5 [BC-REAL-EVAL PROMOTE](wave-bc-real-eval.md) · BC6 [BC-REPORT PROMOTE](wave-bc-summary.md) (`npm run nano:bc:report`) · [paper-lab-wave-bc.md](paper-lab-wave-bc.md); next BC7 BC-FREEZE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

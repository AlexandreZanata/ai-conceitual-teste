...
**Wave AW ACTIVE** — AW0 [SESSION PROMOTE](wave-aw-session.md) (`npm run nano:aw:session`) · AW1 [H-PRODKEEP PROMOTE](formal-hprodkeep-prodkeep.md) (`npm run nano:prodkeep`) — pressure-para **0.95**/20 · FH **0** · DECODE content hold; next AW2 H-SHIPKEEP; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

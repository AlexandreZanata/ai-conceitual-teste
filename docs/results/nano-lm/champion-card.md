...
**Wave AS OPEN** — AS0 [SESSION PROMOTE](wave-as-session.md) · AS1 [H-ASKABSTAIN PROMOTE](formal-haskabstain-askabstain.md) (`npm run nano:askabstain`) · AS2 [H-SEMFIX PROMOTE](formal-hsemfix-semfix.md) (`npm run nano:semfix`) — ADVREG-01/05 FH 0; next **AS3 H-ADVSAFE**.

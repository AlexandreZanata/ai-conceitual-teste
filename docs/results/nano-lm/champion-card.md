...
**Wave BE ACTIVE** — BE0 [SESSION PROMOTE](wave-be-session.md) · BE1 [H-COMPINT PROMOTE](formal-hcompint-compint.md) · BE2 [H-SHIPUSE PROMOTE](formal-hshipuse-shipuse.md) · BE3 [H-FASTBE PROMOTE](formal-hfastbe-fastbe.md) · BE4 [H-CTXBE PROMOTE](formal-hctxbe-ctxbe.md) · BE5 [H-NANOGEN15 DEFER](formal-hnanogen15-nanogen15.md) · BE6 [BE-REAL-EVAL PROMOTE](wave-be-real-eval.md) · BE7 [BE-REPORT PROMOTE](wave-be-summary.md) (`npm run nano:be:report`) · [paper-lab-wave-be.md](paper-lab-wave-be.md); next BE8 BE-FREEZE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

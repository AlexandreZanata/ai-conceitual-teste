...
**Wave BF ACTIVE** — BF0 [SESSION PROMOTE](wave-bf-session.md) · BF1 [H-PREDINT PROMOTE](formal-hpredint-predint.md) · BF2 [H-SHIPUSE2 PROMOTE](formal-hshipuse2-shipuse2.md) · BF3 [H-FASTBF PROMOTE](formal-hfastbf-fastbf.md) · BF4 [H-CTXBF PROMOTE](formal-hctxbf-ctxbf.md) · BF5 [H-NANOGEN16 SKIP](formal-hnanogen16-nanogen16.md) (`npm run nano:nanogen16`) — gen SKIP stop rule · not empty DEFER letter; next BF6 BF-REAL-EVAL; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

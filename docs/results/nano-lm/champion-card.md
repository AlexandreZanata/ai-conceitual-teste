...
**Wave AF OPEN** — AF0 [wave-af-session.md](wave-af-session.md) **PROMOTE** · AF1 [formal-hctxultra-ctxultra.md](formal-hctxultra-ctxultra.md) **PROMOTE** · AF2 [formal-hsmartultra-smartultra.md](formal-hsmartultra-smartultra.md) **PROMOTE**; next **H-FASTULTRA** (`npm run nano:smartultra`).

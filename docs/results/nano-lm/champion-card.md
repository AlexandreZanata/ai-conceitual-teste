...
**Wave AT OPEN** — AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) · AT1 [H-PRODREG PROMOTE](formal-hprodreg-prodreg.md) (`npm run nano:prodreg`) · AT2 [H-SHIPAPP PROMOTE](formal-hshipapp-shipapp.md) (`npm run nano:shipapp`) — ask·apps·ship/demo 4/4; next AT3 H-NANOGEN4; ship **AF + AQ + AS trust path** (no gen claim until NANOGEN4); ≤5M stays; do not invent Wave AU.

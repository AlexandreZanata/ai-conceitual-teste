...
**Wave AX ACTIVE** — AX0 [SESSION PROMOTE](wave-ax-session.md) (`npm run nano:ax:session`) — hard-natural · PRODNAT charter · gen stance **defer** · real-eval · AX1 [H-PRODNAT PROMOTE](formal-hprodnat-prodnat.md) (`npm run nano:prodnat`) — hard-natural **1.0**/18 (18/18) · FH **0** · AX2 [H-SHIPUX PROMOTE](formal-hshipux-shipux.md) (`npm run nano:shipux`) — modes+content · hard-natural LOOKUP · AX3 [H-NANOGEN8 DEFER](formal-hnanogen8-nanogen8.md) (`npm run nano:nanogen8`) — gen stance defer · CAPCHECK closed · not TAC rename · AX4 [AX-REAL-EVAL PROMOTE](wave-ax-real-eval.md) (`npm run nano:ax:real-eval`) — battery 8/8 · gen locked (AX3 DEFER) · AX5 [AX-REPORT PROMOTE](wave-ax-summary.md) (`npm run nano:ax:report`) · [paper-lab-wave-ax.md](paper-lab-wave-ax.md); next AX6 AX-FREEZE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD; ≤5M stays.

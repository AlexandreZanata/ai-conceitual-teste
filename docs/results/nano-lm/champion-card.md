...
**Wave AD OPEN** — [wave-ad-session.md](wave-ad-session.md) · [formal-hhardpara-hardpara.md](formal-hhardpara-hardpara.md) · [formal-hcompose-compose.md](formal-hcompose-compose.md) · [formal-hrouteplus-routeplus.md](formal-hrouteplus-routeplus.md) · [formal-hdeplplus-deplplus.md](formal-hdeplplus-deplplus.md) (held-out ASK→EVAL→FIX; next AD-HITL-10).

...
**Wave AH OPEN** — AH0 [SESSION PROMOTE](wave-ah-session.md) · AH1 [H-GENLIFT HOLD](formal-hgenlift-genlift.md) · AH2 [H-CTXLIFT PROMOTE](formal-hctxlift-ctxlift.md) (`npm run nano:ctxlift`) · next **AH3 H-SMARTLIFT** (ship claim remains **AF packaged stack** until AH6 gen bar).

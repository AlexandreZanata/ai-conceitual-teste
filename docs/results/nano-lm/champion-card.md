...
**Wave BF ACTIVE** — BF0 [SESSION PROMOTE](wave-bf-session.md) · BF1 [H-PREDINT PROMOTE](formal-hpredint-predint.md) · BF2 [H-SHIPUSE2 PROMOTE](formal-hshipuse2-shipuse2.md) (`npm run nano:shipuse2`) — Track A+ utilization; next BF3 H-FASTBF; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

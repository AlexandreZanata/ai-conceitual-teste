...
**Wave AU OPEN** — AU0 [SESSION PROMOTE](wave-au-session.md) (`npm run nano:au:session`) · AU1 [H-PRODHARD PROMOTE](formal-hprodhard-prodhard.md) (`npm run nano:prodhard`) · AU2 [H-SHIPREAL PROMOTE](formal-hshipreal-shipreal.md) (`npm run nano:shipreal`) · AU3 [H-NANOGEN5 PROMOTE](formal-hnanogen5-nanogen5.md) (`npm run nano:nanogen5`) — strict ablated **5.5**; next **AU4 AU-REAL-EVAL**; ship lock remains **AF + AQ + AS trust + ablated DECODE (snippet-prefix)** until AU PROMOTE; ≤5M stays.

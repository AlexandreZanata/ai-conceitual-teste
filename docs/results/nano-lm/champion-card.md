...
**Wave BF ACTIVE** — BF0 [SESSION PROMOTE](wave-bf-session.md) · BF1 [H-PREDINT PROMOTE](formal-hpredint-predint.md) · BF2 [H-SHIPUSE2 PROMOTE](formal-hshipuse2-shipuse2.md) · BF3 [H-FASTBF PROMOTE](formal-hfastbf-fastbf.md) · BF4 [H-CTXBF PROMOTE](formal-hctxbf-ctxbf.md) (`npm run nano:ctxbf`) — ctx 5/5; next BF5 H-NANOGEN16/SKIP; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

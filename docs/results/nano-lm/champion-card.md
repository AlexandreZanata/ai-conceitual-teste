...
**Wave AJ OPEN** — AJ0 [SESSION PROMOTE](wave-aj-session.md) (`npm run nano:aj:session`) · AJ1 [H-GENPEAK PROMOTE](formal-hgenpeak-genpeak.md) (`npm run nano:genpeak`) · next **AJ2 H-CTXPEAK** (ship claim remains **AF packaged stack**; ≤5M stays).

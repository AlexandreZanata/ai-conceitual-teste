...
**Wave AR OPEN** — AR0 [SESSION PROMOTE](wave-ar-session.md) (`npm run nano:ar:session`) · AR1 [H-ABSTAIN PROMOTE](formal-habstain-abstain.md) (`npm run nano:abstain`) — OOD abstain 1.0 · FH 0; next AR2 H-SHIPDEMO; ship claim **AF packaged stack + AQ product layer**; ≤5M stays; do not invent Wave AS.

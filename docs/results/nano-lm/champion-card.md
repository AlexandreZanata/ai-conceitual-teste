...
**Wave AL OPEN** — AL0 [SESSION PROMOTE](wave-al-session.md) (`npm run nano:al:session`) · AL1 [H-GENFRESH HOLD](formal-hgenfresh-genfresh.md) (`npm run nano:genfresh`) · AL2 [H-CTXFRESH PROMOTE](formal-hctxfresh-ctxfresh.md) (`npm run nano:ctxfresh`) · AL3 [H-SMARTFRESH PROMOTE](formal-hsmartfresh-smartfresh.md) (`npm run nano:smartfresh`) · AL4 [H-FASTFRESH PROMOTE](formal-hfastfresh-fastfresh.md) (`npm run nano:fastfresh`) · AL5 [H-APPFRESH PROMOTE](formal-happfresh-appfresh.md) (`npm run nano:appfresh`) · next **AL6 AL-HITL-10** — ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AM.

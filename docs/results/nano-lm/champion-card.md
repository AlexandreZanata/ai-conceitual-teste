...
**Wave AC OPEN** — [wave-ac-session.md](wave-ac-session.md) · [formal-hctxplus-ctxplus.md](formal-hctxplus-ctxplus.md) · [formal-hsmartplus-smartplus.md](formal-hsmartplus-smartplus.md) · [formal-hfastplus-fastplus.md](formal-hfastplus-fastplus.md) · [formal-happplus-appplus.md](formal-happplus-appplus.md) · [wave-ac-hitl.md](wave-ac-hitl.md) (held-out ASK→EVAL→FIX).

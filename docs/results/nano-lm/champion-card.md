...
**Wave AU OPEN** — AU0 [SESSION PROMOTE](wave-au-session.md) (`npm run nano:au:session`) — product-debt · human-para · NANOGEN5 hyp · strict judge · real-eval; next **AU1 H-PRODHARD**; ship lock remains **AF + AQ + AS trust + ablated DECODE (snippet-prefix)** until AU PROMOTE; ≤5M stays.

...
**Wave BC ACTIVE** — BC0 [SESSION PROMOTE](wave-bc-session.md) · BC1 [H-OPSFAM PROMOTE](formal-hopsfam-opsfam.md) · BC2 [H-FASTLIFT PROMOTE](formal-hfastlift-bc2.md) (`npm run nano:bc:fastlift`) — p99_regress=False · BC FH 0; next BC3 H-CTXLIFT2; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

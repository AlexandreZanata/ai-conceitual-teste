...
**Wave AV ACTIVE** — AV0 [SESSION PROMOTE](wave-av-session.md) (`npm run nano:av:session`) · AV1 [H-PRODSHIP PROMOTE](formal-hprodship-prodship.md) (`npm run nano:prodship`) · AV2 [H-SHIPUI2 PROMOTE](formal-hshipui2-shipui2.md) (`npm run nano:shipui2`) — modes+content · DECODE usable/ABSTAIN; next AV3 H-NANOGEN6; ship remains AU lock until AV stage PROMOTE; ≤5M stays; do not invent Wave AW.

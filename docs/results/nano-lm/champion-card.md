...
**PARKED** on Waves A–H. **Next:** Wave I in `.local/pesquisa.md` (**H-SOFT** / **H-BAT**). Deepen only with a formal-PROMOTE parent outside the closed gene-widen / compose trees.

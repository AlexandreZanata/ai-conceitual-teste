...
**Wave BB ACTIVE** — BB0 [SESSION PROMOTE](wave-bb-session.md) (`npm run nano:bb:session`) — BB-FOREVER anti-FP · BA/AZ hold · §1 scoreboard · ctx/speed baselines · gen stance **defer** (H-NANOGEN12 · M1|M2|M3) · real-eval; next BB1 H-INTENTGEN; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; NANOGEN6·7 HOLD · NANOGEN8·9·10·11 DEFER; ≤5M stays.

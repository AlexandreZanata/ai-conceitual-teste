...
> Deploy: [RECIPES.md](RECIPES.md) · **DEPL-Y frozen:** [wave-z-depl-y.md](wave-z-depl-y.md). Lab: `.local/pesquisa.md` (**Z COMPLETE** · **Wave AA COMPLETE** · **Wave AB COMPLETE + FROZEN** · **Wave AC COMPLETE + FROZEN** · **Wave AD COMPLETE + FROZEN** · **Wave AE COMPLETE + FROZEN** · **Wave AF COMPLETE + FROZEN** · **Wave AG COMPLETE + FROZEN** · **Wave AH COMPLETE + FROZEN** · **Wave AI COMPLETE + FROZEN** — [ai-freeze.md](ai-freeze.md) · **Wave AJ COMPLETE + FROZEN** — [aj-freeze.md](aj-freeze.md) · **Wave AK COMPLETE + FROZEN** — [ak-freeze.md](ak-freeze.md) · **Wave AL COMPLETE + FROZEN** — [al-freeze.md](al-freeze.md) · **Wave AM COMPLETE + FROZEN** — [am-freeze.md](am-freeze.md) · **Wave AN COMPLETE + FROZEN** — [an-freeze.md](an-freeze.md) · **Wave AO COMPLETE + FROZEN** — [ao-freeze.md](ao-freeze.md) · **Wave AP COMPLETE + FROZEN** — [ap-freeze.md](ap-freeze.md) · **Wave AQ COMPLETE + FROZEN** — [aq-freeze.md](aq-freeze.md) · **Wave AR COMPLETE + FROZEN** — [ar-freeze.md](ar-freeze.md) · **Wave AS COMPLETE + FROZEN** — [as-freeze.md](as-freeze.md) · **Wave AT OPEN** — [wave-at-session.md](wave-at-session.md)).
**Wave AT OPEN** — AT0 [SESSION PROMOTE](wave-at-session.md) (`npm run nano:at:session`) · AT1 [H-PRODREG PROMOTE](formal-hprodreg-prodreg.md) (`npm run nano:prodreg`) · AT2 [H-SHIPAPP PROMOTE](formal-hshipapp-shipapp.md) (`npm run nano:shipapp`) — ask·apps·ship/demo 4/4; AT3 [H-NANOGEN4 PROMOTE](formal-hnanogen4-nanogen4.md) (`npm run nano:nanogen4`) — ablated **5.5**; AT4 [AT-REAL-EVAL PROMOTE](wave-at-real-eval.md) (`npm run nano:at:real-eval`) — battery 6/6; AT5 [AT-REPORT PROMOTE](wave-at-summary.md) (`npm run nano:at:report`) · [paper-lab-wave-at.md](paper-lab-wave-at.md); next AT6 AT-FREEZE; ship **AF + AQ + AS trust + ablated DECODE (snippet-prefix)**; ≤5M stays; do not invent Wave AU.

...
**Wave BA ACTIVE** — BA0 [SESSION PROMOTE](wave-ba-session.md) · BA1 [H-REALGAIN PROMOTE](formal-hrealgain-realgain.md) · BA2 [H-FASTREAL PROMOTE](formal-hfastreal-ba2.md) · BA3 [H-CTXREAL2 PROMOTE](formal-hctxreal2-ctxreal2.md) · BA4 [H-NANOGEN11 DEFER](formal-hnanogen11-nanogen11.md) · BA5 [BA-REAL-EVAL PROMOTE](wave-ba-real-eval.md) · BA6 [BA-REPORT PROMOTE](wave-ba-summary.md) (`npm run nano:ba:report`) · [paper-lab-wave-ba.md](paper-lab-wave-ba.md); next BA7 BA-FREEZE; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

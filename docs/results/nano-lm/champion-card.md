...
**Wave AR OPEN** — AR0 [SESSION PROMOTE](wave-ar-session.md) (`npm run nano:ar:session`) — external-para-20 · advreg-20 · abstain protocol · ship-demo charter · NANOGEN2 hyp; next AR1 H-ABSTAIN; ship claim **AF packaged stack + AQ product layer**; ≤5M stays; do not invent Wave AS.

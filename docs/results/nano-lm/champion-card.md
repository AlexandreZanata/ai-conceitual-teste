...
**Wave BE ACTIVE** — BE0 [SESSION PROMOTE](wave-be-session.md) · BE1 [H-COMPINT PROMOTE](formal-hcompint-compint.md) · BE2 [H-SHIPUSE PROMOTE](formal-hshipuse-shipuse.md) · BE3 [H-FASTBE PROMOTE](formal-hfastbe-fastbe.md) · BE4 [H-CTXBE PROMOTE](formal-hctxbe-ctxbe.md) (`npm run nano:ctxbe`) — ctx_ok 5/5 · BE FH 0; next BE5 H-NANOGEN15; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

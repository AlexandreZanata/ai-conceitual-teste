...
**Wave BB ACTIVE** — BB0 [SESSION PROMOTE](wave-bb-session.md) · BB1 [H-INTENTGEN PROMOTE](formal-hintentgen-intentgen.md) (`npm run nano:intentgen`) — BB FH 0 · BA hold 0; next BB2 H-FASTHOLD; ship remains **AF + AQ + AS trust + STRICT ablated DECODE**; ≤5M stays.

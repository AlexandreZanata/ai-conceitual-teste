...
|------|--------|-----|-----------------|
| 1. Train | Curriculum KD | **H-CURL** (`seq_lo=8`, `n_stages=3`) | [formal-hcurl-vs-hcur.md](formal-hcurl-vs-hcur.md) |
...
Parents kept for lineage: **H-CUR** (train), **H-DECKL ← H-DECK ← H-DEC** (decode).
...
| **H-CURL** | train | **−13.36** | — | official train |
...
**PARKED.** Deepen CURL / EARLY / POOL separately if needed. No new compose H-ID until a formal-PROMOTE parent outside this tree.

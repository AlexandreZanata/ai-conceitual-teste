...
> Deploy: [RECIPES.md](RECIPES.md) · **DEPL-Y frozen:** [wave-z-depl-y.md](wave-z-depl-y.md). Lab: `.local/pesquisa.md` (**Z COMPLETE** · **Wave AA COMPLETE** · **Wave AB COMPLETE + FROZEN** · **Wave AC COMPLETE + FROZEN** · **Wave AD COMPLETE + FROZEN** · **Wave AE COMPLETE + FROZEN** · **Wave AF COMPLETE + FROZEN** · **Wave AG COMPLETE + FROZEN** · **Wave AH COMPLETE + FROZEN** · **Wave AI OPEN** — AI0 [SESSION](wave-ai-session.md)).  
...
**Wave AI OPEN** — AI0 [SESSION PROMOTE](wave-ai-session.md) · AI1 [H-GENPLUS HOLD](formal-hgenplus-genplus.md) · AI1b [H-CAPRENEG HOLD](formal-hcapreneg-capreneg.md) · AI2 [H-CTXPUSH PROMOTE](formal-hctxpush-ctxpush.md) (`npm run nano:ctxpush`) · next **AI3 H-SMARTPUSH** (ship claim remains **AF packaged stack**; ≤5M stays).

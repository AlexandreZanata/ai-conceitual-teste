...
Next: **AJ1 H-GENPEAK** — **DONE PROMOTE** → [formal-hgenpeak-genpeak.md](formal-hgenpeak-genpeak.md). **AJ2 H-CTXPEAK** — **DONE PROMOTE** → [formal-hctxpeak-ctxpeak.md](formal-hctxpeak-ctxpeak.md). **AJ3 H-SMARTPEAK** — **DONE PROMOTE** → [formal-hsmartpeak-smartpeak.md](formal-hsmartpeak-smartpeak.md). Next: **AJ4 H-FASTPEAK**.

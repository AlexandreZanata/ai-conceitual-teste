...
**Status: COMPLETE** (AB0). **AB1 H-SEMWRAP PROMOTE** — [formal-hsemwrap-semwrap.md](formal-hsemwrap-semwrap.md). **AB2 H-ASKFAST PROMOTE** — [formal-haskfast-askfast.md](formal-haskfast-askfast.md). Next: **AB3 H-LONGAPP**.

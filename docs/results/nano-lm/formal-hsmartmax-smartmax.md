...
Next: **AE3 H-FASTMAX** (**DONE** — see [formal-hfastmax-fastmax.md](formal-hfastmax-fastmax.md)). **AE4 H-APPMAX** (**DONE** — see [formal-happmax-appmax.md](formal-happmax-appmax.md)). Next wave stage: **AE5 AE-HITL-10**.

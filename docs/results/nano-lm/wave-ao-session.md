...
Next: **AO1 H-GENCORE** — **DONE HOLD** → [formal-hgencore-gencore.md](formal-hgencore-gencore.md). **AO2 H-CTXCORE PROMOTE** → [formal-hctxcore-ctxcore.md](formal-hctxcore-ctxcore.md). **AO3 H-SMARTCORE PROMOTE** → [formal-hsmartcore-smartcore.md](formal-hsmartcore-smartcore.md). **AO4 H-FASTCORE PROMOTE** → [formal-hfastcore-fastcore.md](formal-hfastcore-fastcore.md). **AO5 H-APPCORE PROMOTE** → [formal-happcore-appcore.md](formal-happcore-appcore.md). **AO6 AO-HITL-10 PROMOTE** → [wave-ao-hitl.md](wave-ao-hitl.md). **AO7 AO-REPORT PROMOTE** → [wave-ao-summary.md](wave-ao-summary.md) · [paper-lab-wave-ao.md](paper-lab-wave-ao.md). **AO8 AO-FREEZE PROMOTE** → [ao-freeze.md](ao-freeze.md) · [formal-haofreeze-ao-freeze.md](formal-haofreeze-ao-freeze.md). Do **not** invent Wave AP.

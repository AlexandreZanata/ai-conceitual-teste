...
Next: **AO1 H-GENCORE** — **DONE HOLD** → [formal-hgencore-gencore.md](formal-hgencore-gencore.md). **AO2 H-CTXCORE PROMOTE** → [formal-hctxcore-ctxcore.md](formal-hctxcore-ctxcore.md). **AO3 H-SMARTCORE PROMOTE** → [formal-hsmartcore-smartcore.md](formal-hsmartcore-smartcore.md). Next **AO4 H-FASTCORE**.

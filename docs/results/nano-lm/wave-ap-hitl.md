...
Next: **AP7 AP-REPORT** — **DONE PROMOTE** → [wave-ap-summary.md](wave-ap-summary.md) · [paper-lab-wave-ap.md](paper-lab-wave-ap.md). **AP8 AP-FREEZE** — **DONE PROMOTE** → [ap-freeze.md](ap-freeze.md) · [formal-hapfreeze-ap-freeze.md](formal-hapfreeze-ap-freeze.md). Do **not** invent Wave AQ.

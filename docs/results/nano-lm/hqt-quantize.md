# H-QT smoke — int8 weight-only PACK/EARLY serve
...
|-----|-----------------------|----------------------|--------------|--------------|---|
| H-EARLY fp | -14.8854 | -16.2692 | 22 | 13920008 | 12 |
| H-QT int8 | -14.8854 | -16.2692 | 10 | 13629704 | 12 |

Tips unchanged. Wave X quantized PACK serve.

Commands: `npm run nano:qt` → `npm run nano:qt:report`.

...
Next: **AE1 H-CTXMAX** (**DONE** — see [formal-hctxmax-ctxmax.md](formal-hctxmax-ctxmax.md)). **AE2 H-SMARTMAX** (**DONE** — see [formal-hsmartmax-smartmax.md](formal-hsmartmax-smartmax.md)). Next wave stage: **AE3 H-FASTMAX**.

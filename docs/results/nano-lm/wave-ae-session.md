...
Next: **AE1 H-CTXMAX** (**DONE** — see [formal-hctxmax-ctxmax.md](formal-hctxmax-ctxmax.md)). **AE2 H-SMARTMAX** (**DONE** — see [formal-hsmartmax-smartmax.md](formal-hsmartmax-smartmax.md)). **AE3 H-FASTMAX** (**DONE** — see [formal-hfastmax-fastmax.md](formal-hfastmax-fastmax.md)). **AE4 H-APPMAX** (**DONE** — see [formal-happmax-appmax.md](formal-happmax-appmax.md)). **AE5 AE-HITL-10** (**DONE** — see [wave-ae-hitl.md](wave-ae-hitl.md)). Next wave stage: **AE6 AE-REPORT**.

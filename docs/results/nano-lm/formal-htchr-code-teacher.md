# Formal H-TCHR — tiny code teacher wire (prog@128)

Source: `results/nano-lm/formal-htchr/formal.json`
Wall clock: 10.5s
...
|--------|-----------------------|----------------------|--------------|---------------|---|
| H-EARLY | -8.1626 | -14.1457 | 24 | 12 | 12 |

Tips unchanged. Wave X code-teacher wire.

Commands: `npm run nano:formal:htchr` → `npm run nano:formal:htchr:report`.

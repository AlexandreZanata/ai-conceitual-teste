...
Next: **AP1 H-GENBASE** — **DONE HOLD** → [formal-hgenbase-genbase.md](formal-hgenbase-genbase.md). **AP2 H-CTXBASE** — **DONE PROMOTE** → [formal-hctxbase-ctxbase.md](formal-hctxbase-ctxbase.md). **AP3 H-SMARTBASE** — **DONE PROMOTE** → [formal-hsmartbase-smartbase.md](formal-hsmartbase-smartbase.md). **AP4 H-FASTBASE** — **DONE PROMOTE** → [formal-hfastbase-fastbase.md](formal-hfastbase-fastbase.md). **AP5 H-APPBASE** — **DONE PROMOTE** → [formal-happbase-appbase.md](formal-happbase-appbase.md). **AP6 AP-HITL-10** — **DONE PROMOTE** → [wave-ap-hitl.md](wave-ap-hitl.md). **AP7 AP-REPORT** — **DONE PROMOTE** → [wave-ap-summary.md](wave-ap-summary.md) · [paper-lab-wave-ap.md](paper-lab-wave-ap.md). **AP8 AP-FREEZE** — **DONE PROMOTE** → [ap-freeze.md](ap-freeze.md) · [formal-hapfreeze-ap-freeze.md](formal-hapfreeze-ap-freeze.md). Do **not** invent Wave AQ.

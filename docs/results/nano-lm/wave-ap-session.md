...
Next: **AP1 H-GENBASE** — **DONE HOLD** → [formal-hgenbase-genbase.md](formal-hgenbase-genbase.md). **AP2 H-CTXBASE** — **DONE PROMOTE** → [formal-hctxbase-ctxbase.md](formal-hctxbase-ctxbase.md). Next **AP3 H-SMARTBASE**.

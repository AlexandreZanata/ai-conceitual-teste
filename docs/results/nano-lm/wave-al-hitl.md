...
Next: **AL7 AL-REPORT** — **DONE PROMOTE** → [wave-al-summary.md](wave-al-summary.md) · [paper-lab-wave-al.md](paper-lab-wave-al.md). **AL8 AL-FREEZE** — **DONE PROMOTE** → [al-freeze.md](al-freeze.md) · [formal-halfreeze-al-freeze.md](formal-halfreeze-al-freeze.md).

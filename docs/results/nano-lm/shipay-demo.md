# SHIPAY — mode always visible (ask · apps · ship/demo)
...
| PEAK | **PEAK** | `mode=PEAK · wall_ms=0.1355 · n_new=14 · raw=PEAK_FAST+GENBASE` |
| ABSTAIN | **ABSTAIN** | `mode=ABSTAIN · wall_ms=188.1997 · n_new=64 · raw=NO_ANSWER` |
...
| modeui_line | `mode=ABSTAIN · wall_ms=362.7506 · n_new=64 · raw=NO_ANSWER` |

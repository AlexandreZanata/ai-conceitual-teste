...
Formal reverse-check recommended (smoke promotes have reversed before).

Commands: `npm run nano:sho` → `npm run nano:matrix:report`.  
Artifacts: `results/nano-lm/student-matrix/sho_smoke.json`, `HSHO_seed*_train.json`.

...
**Wave Y ACTIVE** — [wave-y-summary.md](wave-y-summary.md) (**H-BEAMKV** + **H-TCACHE PROMOTE**; next H-SCORERAM). Corpus E1–E5: `CURATED-SOURCES.md` · [e5-eval-suites.md](e5-eval-suites.md).

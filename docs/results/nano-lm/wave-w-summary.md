...
**Wave Y ACTIVE** — [wave-y-summary.md](wave-y-summary.md) (PFB256/ROLL **PROMOTE**; STREAM **KILL**; next H-SUMCACHE). Corpus E1–E5: `CURATED-SOURCES.md` · [e5-eval-suites.md](e5-eval-suites.md).

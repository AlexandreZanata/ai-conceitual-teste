...
**Wave Y ACTIVE** — [wave-y-summary.md](wave-y-summary.md) (serve-cache + **H-PFB256** / **H-ROLL PROMOTE**; next H-STREAM). Corpus E1–E5: `CURATED-SOURCES.md` · [e5-eval-suites.md](e5-eval-suites.md).

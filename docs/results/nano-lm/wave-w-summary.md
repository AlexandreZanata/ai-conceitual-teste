...
**PARKED.** Candidates (H-TCHR / H-TOK / H-RAG / H-QT / H-DIST) open only when data demands a **new mechanism**. Default: park; optional next work is corpus growth (Phase E) via registry PRs only.

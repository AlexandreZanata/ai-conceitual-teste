# SHIPAZ — mode always visible (ask · apps · ship/demo)
...
| PEAK | **PEAK** | `mode=PEAK · wall_ms=0.1601 · n_new=14 · raw=PEAK_FAST+GENBASE` |
| ABSTAIN | **ABSTAIN** | `mode=ABSTAIN · wall_ms=166.8070 · n_new=64 · raw=NO_ANSWER` |
...
| modeui_line | `mode=ABSTAIN · wall_ms=338.0919 · n_new=64 · raw=NO_ANSWER` |

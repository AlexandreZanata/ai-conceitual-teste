...
Wave X+ **ACTIVE** — **H-TCHR** / **H-QT** **[PROMOTE](results/nano-lm/formal-htchr-code-teacher.md)** / **[PROMOTE](results/nano-lm/formal-hqt-quantize.md)** · **H-RAG** / **H-CTX** / **H-CKD** **KILL** → QCTX/GENC (see `.local/pesquisa.md`). Phase E corpus **DONE** ([e5-eval-suites.md](results/nano-lm/e5-eval-suites.md)).

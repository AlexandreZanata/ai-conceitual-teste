...
| **AK** | **OPEN** | AK0 [SESSION PROMOTE](results/nano-lm/wave-ak-session.md) · AK1 [H-GENTRUE HOLD](results/nano-lm/formal-hgentrue-gentrue.md) · AK2 [H-CTXMORE PROMOTE](results/nano-lm/formal-hctxmore-ctxmore.md) · AK3 [H-SMARTMORE PROMOTE](results/nano-lm/formal-hsmartmore-smartmore.md) · AK4 [H-FASTMORE PROMOTE](results/nano-lm/formal-hfastmore-fastmore.md) · AK5 [H-APPMORE PROMOTE](results/nano-lm/formal-happmore-appmore.md) · AK6 [AK-HITL-10 PROMOTE](results/nano-lm/wave-ak-hitl.md) (`npm run nano:ak:hitl`) · next **AK7 AK-REPORT** — ship remains **AF packaged stack**; ≤5M stays |

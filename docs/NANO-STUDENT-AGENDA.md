...
Wave X+ **ACTIVE** — **H-TCHR** smoke+formal **[PROMOTE](results/nano-lm/formal-htchr-code-teacher.md)** · **H-RAG** **[KILL](results/nano-lm/archive/hrag-retrieve.md)** · **H-CTX** **[KILL](results/nano-lm/archive/hctx-long-window.md)** → **H-QT** → QCTX/GENC (see `.local/pesquisa.md`). Phase E corpus **DONE** ([e5-eval-suites.md](results/nano-lm/e5-eval-suites.md)).

...
| Utils | H-LAY / H-PRUN / H-SHORT / H-BAT / **H-TOP** / **H-FLASH** | formal PROMOTE | tip unchanged |
| Metrics | **H-FLOP** | smoke PROMOTE | wall + tok/s + GFLOPs |

Protocol: train **H-STAG**, decode **H-EARLY** or **H-POOL**. Never paste tips.  
Next queue: `.local/pesquisa.md` (backlog **H-KVSEL** / **H-DEPTH**). Card: [`champion-card.md`](results/nano-lm/champion-card.md).
...
Post-J: **H-FLASH** formal PROMOTE (SDPA wall).  

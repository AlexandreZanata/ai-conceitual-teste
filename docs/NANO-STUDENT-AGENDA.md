...
H-EAR2 / H-BUD / H-Q8 / H-EARS / H-COMP / H-PROX / H-POOL2 smoke **KILL**; H-THIN formal **KILL**. Next: `.local/pesquisa.md` (Wave C or **D2 H-FLOP**). Card: [`champion-card.md`](results/nano-lm/champion-card.md).

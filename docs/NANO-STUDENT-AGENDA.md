...
| **AM** | **OPEN** | AM0 [SESSION PROMOTE](results/nano-lm/wave-am-session.md) (`npm run nano:am:session`) · AM1 [H-GENTRUTH HOLD](results/nano-lm/formal-hgentruth-gentruth.md) (`npm run nano:gentruth`) — ablated gen 4.0; next AM2 H-CTXNEXT |

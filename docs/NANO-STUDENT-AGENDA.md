...
| H-NGRAM★ / H-MINP | Grid n-gram / min-p sampling | both **smoke/formal PROMOTE** |
...
| 61 | NGRAM★; MINP **formal PROMOTE** Δ+1.17; stacks/TKD KILL |
## Success
≥1 H-ID beats B2 quality **or** tokens/s (+ ablation). Negatives logged.

...
| Throughput | BAT / POOLB / CBAT / CPOOLB / CHBAT / FUSEB / **FCPOOLB** | formal PROMOTE |
...
Queue: `.local/pesquisa.md` (**Wave N** — N1 FCPOOLB done; **next N2 H-LAYB**). Card: [`champion-card.md`](results/nano-lm/champion-card.md).

...
| **AL** | **OPEN** | AL0 [SESSION PROMOTE](results/nano-lm/wave-al-session.md) · AL1 [H-GENFRESH HOLD](results/nano-lm/formal-hgenfresh-genfresh.md) · AL2 [H-CTXFRESH PROMOTE](results/nano-lm/formal-hctxfresh-ctxfresh.md) (`npm run nano:ctxfresh`) · AL3 [H-SMARTFRESH PROMOTE](results/nano-lm/formal-hsmartfresh-smartfresh.md) (`npm run nano:smartfresh`) · AL4 [H-FASTFRESH PROMOTE](results/nano-lm/formal-hfastfresh-fastfresh.md) (`npm run nano:fastfresh`) · AL5 [H-APPFRESH PROMOTE](results/nano-lm/formal-happfresh-appfresh.md) (`npm run nano:appfresh`) · AL6 [AL-HITL-10 PROMOTE](results/nano-lm/wave-al-hitl.md) (`npm run nano:al:hitl`) · AL7 [AL-REPORT PROMOTE](results/nano-lm/wave-al-summary.md) (`npm run nano:al:report`) · [paper-lab-wave-al.md](results/nano-lm/paper-lab-wave-al.md) · next **AL8 AL-FREEZE** — ship remains **AF packaged stack**; ≤5M stays |

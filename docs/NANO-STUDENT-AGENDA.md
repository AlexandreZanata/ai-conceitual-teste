...
| **AM** | **OPEN** | AM0 [SESSION PROMOTE](results/nano-lm/wave-am-session.md) · AM1 [H-GENTRUTH HOLD](results/nano-lm/formal-hgentruth-gentruth.md) · AM2 [H-CTXNEXT PROMOTE](results/nano-lm/formal-hctxnext-ctxnext.md) (`npm run nano:ctxnext`) — L_eff 213147; next AM3 H-SMARTNEXT |

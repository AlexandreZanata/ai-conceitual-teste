...
| Throughput | BAT / POOLB / CBAT / CPOOLB / CHBAT / FUSEB / FCPOOLB / LAYB / FLAYB / GRAPH / **GRAPHF** | formal PROMOTE |
...
Queue: `.local/pesquisa.md` (**Wave Q** — Q1 GRAPHF formal PROMOTE; continue or park). Card: [`champion-card.md`](results/nano-lm/champion-card.md).

...
| **Z** | **ACTIVE** | **DEPL→Z6 NEXT** — [wave-z-summary.md](results/nano-lm/wave-z-summary.md) · Z4 **PASS** [wave-z-hitl-z4.md](results/nano-lm/wave-z-hitl-z4.md) · ladder in `.local/pesquisa.md` §8 |

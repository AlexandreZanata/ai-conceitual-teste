...
| **AK** | **OPEN** | AK0 [SESSION PROMOTE](results/nano-lm/wave-ak-session.md) · AK1 [H-GENTRUE HOLD](results/nano-lm/formal-hgentrue-gentrue.md) · AK2 [H-CTXMORE PROMOTE](results/nano-lm/formal-hctxmore-ctxmore.md) (`npm run nano:ctxmore`) · next **AK3 H-SMARTMORE** — ship remains **AF packaged stack**; ≤5M stays |

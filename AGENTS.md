...
- **Wave AI OPEN** — AI0–AI6 done; AI7 [AI-REPORT PROMOTE](docs/results/nano-lm/wave-ai-summary.md) (`npm run nano:ai:report`) · [paper-lab-wave-ai.md](docs/results/nano-lm/paper-lab-wave-ai.md); next **AI8 AI-FREEZE**; ship claim remains **AF packaged stack**; ≤5M stays; no Wave AJ invent without reopen.

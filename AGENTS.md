...
- **Wave AE OPEN** — AE0 [wave-ae-session.md](docs/results/nano-lm/wave-ae-session.md) **PROMOTE** (`npm run nano:ae:session`); next **H-CTXMAX**; ship claim remains AD stack until AE5; no Wave AF invent.

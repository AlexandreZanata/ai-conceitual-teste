...
5. `.local/pesquisa.md` (Wave Z **ACTIVE** — Z0 EXPORT **DONE**; next **Z1 HITL-10**) before new H-IDs
...
- **Wave Z ACTIVE** — Z0 EXPORT **DONE** (`champion-qpfb2-v0`); next **Z1 HITL-10** — see `.local/pesquisa.md` §9 + [`wave-z-summary.md`](docs/results/nano-lm/wave-z-summary.md) · [`wave-z-export.md`](docs/results/nano-lm/wave-z-export.md).

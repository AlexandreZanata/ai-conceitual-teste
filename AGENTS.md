...
- **Wave AN OPEN** — AN0 [SESSION PROMOTE](docs/results/nano-lm/wave-an-session.md) (`npm run nano:an:session`); next AN1 H-GENEDGE; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AO.

...
5. `.local/pesquisa.md` (Wave Y **COMPLETE** — GPFB4-LONG **PROMOTE**; next **Wave Z** §9) before new H-IDs
...
- **Wave Y COMPLETE** — GPFB4-LONG **PROMOTE**; STREAM/KVCACHE-Q/GENCACHE **KILL**; next **Wave Z** — see `.local/pesquisa.md` + [`wave-y-summary.md`](docs/results/nano-lm/wave-y-summary.md) · [`formal-hgpfb4long-gpfb4long.md`](docs/results/nano-lm/formal-hgpfb4long-gpfb4long.md).

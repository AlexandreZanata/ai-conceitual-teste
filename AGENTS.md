...
- **Wave AH OPEN** — AH0 [SESSION PROMOTE](docs/results/nano-lm/wave-ah-session.md) · AH1 [H-GENLIFT HOLD](docs/results/nano-lm/formal-hgenlift-genlift.md) (`npm run nano:genlift`); next **AH2 H-CTXLIFT**; ship claim remains **AF packaged stack** until AH6 gen bar; no Wave AI invent without reopen.

...
- **Wave AI OPEN** — AI0 [SESSION PROMOTE](docs/results/nano-lm/wave-ai-session.md) (`npm run nano:ai:session`); next **AI1 H-GENPLUS**; ship claim remains **AF packaged stack**; no Wave AJ invent without reopen.

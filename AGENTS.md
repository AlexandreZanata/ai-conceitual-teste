...
5. `.local/pesquisa.md` (Wave W COMPLETE; Wave X ACTIVE — H-TCHR/H-QT PROMOTE; H-RAG/H-CTX KILL; next H-CKD) before new H-IDs
...
- **Wave X ACTIVE** — H-TCHR/H-QT **PROMOTE**; H-RAG/H-CTX **KILL**; next H-CKD — see `.local/pesquisa.md` + [`formal-htchr-code-teacher.md`](docs/results/nano-lm/formal-htchr-code-teacher.md) · [`formal-hqt-quantize.md`](docs/results/nano-lm/formal-hqt-quantize.md).

...
- **Wave AJ OPEN** — AJ0 [SESSION PROMOTE](docs/results/nano-lm/wave-aj-session.md) (`npm run nano:aj:session`); next **AJ1 H-GENPEAK**; ship claim remains **AF packaged stack**; ≤5M stays; no Wave AK invent without reopen.

...
- **Wave AC OPEN** — [wave-ac-session.md](docs/results/nano-lm/wave-ac-session.md) · [formal-hctxplus-ctxplus.md](docs/results/nano-lm/formal-hctxplus-ctxplus.md) · [formal-hsmartplus-smartplus.md](docs/results/nano-lm/formal-hsmartplus-smartplus.md) (`npm run nano:ac:session` · `npm run nano:ctxplus` · `npm run nano:smartplus`).

...
- **Wave AI OPEN** — AI0 [SESSION PROMOTE](docs/results/nano-lm/wave-ai-session.md) (`npm run nano:ai:session`); AI1 [H-GENPLUS HOLD](docs/results/nano-lm/formal-hgenplus-genplus.md) (`npm run nano:genplus`); next **AI1b H-CAPRENEG** (optional) or **AI2 H-CTXPUSH**; ship claim remains **AF packaged stack**; no Wave AJ invent without reopen.

...
- **Wave AL OPEN** — AL0 [SESSION PROMOTE](docs/results/nano-lm/wave-al-session.md) (`npm run nano:al:session`); AL1 [H-GENFRESH HOLD](docs/results/nano-lm/formal-hgenfresh-genfresh.md) (`npm run nano:genfresh`); next **AL2 H-CTXFRESH**; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AM.

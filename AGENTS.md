...
- **Wave AH OPEN** — AH0 [SESSION PROMOTE](docs/results/nano-lm/wave-ah-session.md) · AH1 [H-GENLIFT HOLD](docs/results/nano-lm/formal-hgenlift-genlift.md) · AH2 [H-CTXLIFT PROMOTE](docs/results/nano-lm/formal-hctxlift-ctxlift.md) · AH3 [H-SMARTLIFT HOLD](docs/results/nano-lm/formal-hsmartlift-smartlift.md) · AH4 [H-FASTLIFT PROMOTE](docs/results/nano-lm/formal-hfastlift-fastlift.md) · AH5 [H-APPLIFT HOLD](docs/results/nano-lm/formal-happlift-applift.md) (`npm run nano:applift`); next **AH6 AH-HITL-10**; ship claim remains **AF packaged stack** until AH6 gen bar; no Wave AI invent without reopen.

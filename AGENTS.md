...
- **Wave AN OPEN** — AN0 [SESSION PROMOTE](docs/results/nano-lm/wave-an-session.md) (`npm run nano:an:session`); AN1 [H-GENEDGE HOLD](docs/results/nano-lm/formal-hgenedge-genedge.md) (`npm run nano:genedge`); next AN2 H-CTXEDGE; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AO.

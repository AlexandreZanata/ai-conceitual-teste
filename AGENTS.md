...
5. `.local/pesquisa.md` (lab **NO-REOPEN** KILLs; Waves W–AA **COMPLETE**; **Wave AB OPEN** — AB0–AB4 **DONE** · [formal-hasksmart-asksmart.md](docs/results/nano-lm/formal-hasksmart-asksmart.md))
...
- **Wave AB OPEN** — AB0–AB4 **PROMOTE** — [formal-hasksmart-asksmart.md](docs/results/nano-lm/formal-hasksmart-asksmart.md); next **AB5 H-REALAPP**.

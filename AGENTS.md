...
- **Wave AK OPEN** — AK0 [SESSION PROMOTE](docs/results/nano-lm/wave-ak-session.md) (`npm run nano:ak:session`); AK1 [H-GENTRUE HOLD](docs/results/nano-lm/formal-hgentrue-gentrue.md) (`npm run nano:gentrue`); next **AK2 H-CTXMORE**; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AL.

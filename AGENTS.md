...
5. `.local/pesquisa.md` (lab **NO-REOPEN** KILLs; Waves W–AA **COMPLETE**; **Wave AB OPEN** — AB0 **DONE** · [wave-ab-session.md](docs/results/nano-lm/wave-ab-session.md))
...
- **Wave AB OPEN** — AB0 SESSION **PROMOTE** — [wave-ab-session.md](docs/results/nano-lm/wave-ab-session.md); next **AB1 H-SEMWRAP**.

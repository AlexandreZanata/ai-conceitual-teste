...
- **Wave AC OPEN** — [wave-ac-session.md](docs/results/nano-lm/wave-ac-session.md) · [formal-hctxplus-ctxplus.md](docs/results/nano-lm/formal-hctxplus-ctxplus.md) · [formal-hsmartplus-smartplus.md](docs/results/nano-lm/formal-hsmartplus-smartplus.md) · [formal-hfastplus-fastplus.md](docs/results/nano-lm/formal-hfastplus-fastplus.md) · [formal-happplus-appplus.md](docs/results/nano-lm/formal-happplus-appplus.md) · [wave-ac-hitl.md](docs/results/nano-lm/wave-ac-hitl.md) (`npm run nano:ac:session` · `npm run nano:ctxplus` · `npm run nano:smartplus` · `npm run nano:fastplus` · `npm run nano:appplus` · `npm run nano:ac:hitl`).

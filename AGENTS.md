...
5. `.local/pesquisa.md` (lab **NO-REOPEN** KILLs; Waves W–AA **COMPLETE**; **Wave AB OPEN** — AB0–AB3 **DONE** · [formal-hlongapp-longapp.md](docs/results/nano-lm/formal-hlongapp-longapp.md))
...
- **Wave AB OPEN** — AB0–AB3 **PROMOTE** — [formal-hlongapp-longapp.md](docs/results/nano-lm/formal-hlongapp-longapp.md); next **AB4 H-ASKSMART**.

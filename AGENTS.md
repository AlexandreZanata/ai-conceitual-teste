...
- **Wave AH OPEN (report done)** — AH0–AH6 done · AH7 [AH-REPORT PROMOTE](docs/results/nano-lm/wave-ah-summary.md) · [paper-lab-wave-ah.md](docs/results/nano-lm/paper-lab-wave-ah.md) (`npm run nano:ah:report`); next **AH8 AH-FREEZE**; ship claim remains **AF packaged stack**; no Wave AI invent without reopen.

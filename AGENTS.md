...
- **Wave AG OPEN** — [wave-ag-session.md](docs/results/nano-lm/wave-ag-session.md) · [formal-hantifp-antifp.md](docs/results/nano-lm/formal-hantifp-antifp.md) · [formal-hctxreal-ctxreal.md](docs/results/nano-lm/formal-hctxreal-ctxreal.md) · [formal-hsmartreal-smartreal.md](docs/results/nano-lm/formal-hsmartreal-smartreal.md) · [formal-hfastreal-fastreal.md](docs/results/nano-lm/formal-hfastreal-fastreal.md) · [formal-happreal-appreal.md](docs/results/nano-lm/formal-happreal-appreal.md) · [wave-ag-hitl.md](docs/results/nano-lm/wave-ag-hitl.md) (`npm run nano:ag:session` · `npm run nano:antifp` · `npm run nano:ctxreal` · `npm run nano:smartreal` · `npm run nano:fastreal` · `npm run nano:appreal` · `npm run nano:ag:hitl`); next **AG7 AG-REPORT**; ship claim remains **AF packaged stack**; no Wave AH invent without reopen.

...
- **Wave AO OPEN** — AO0 [SESSION PROMOTE](docs/results/nano-lm/wave-ao-session.md) (`npm run nano:ao:session`); next AO1 H-GENCORE; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AP.

...
- **Wave AH OPEN** — AH0 [SESSION PROMOTE](docs/results/nano-lm/wave-ah-session.md) (`npm run nano:ah:session`); next **AH1 H-GENLIFT**; ship claim remains **AF packaged stack** until AH6 gen bar; no Wave AI invent without reopen.

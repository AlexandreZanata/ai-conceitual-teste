...
5. `.local/pesquisa.md` (Wave Y ACTIVE — PFB256/ROLL **PROMOTE**; STREAM **KILL**; next **H-SUMCACHE**) before new H-IDs
...
- **Wave Y ACTIVE** — PFB256/ROLL **PROMOTE**; STREAM **KILL**; next **H-SUMCACHE** — see `.local/pesquisa.md` + [`wave-y-summary.md`](docs/results/nano-lm/wave-y-summary.md) · [`archive/hstream-stream.md`](docs/results/nano-lm/archive/hstream-stream.md).

...
- **Wave AO OPEN** — AO0 [SESSION PROMOTE](docs/results/nano-lm/wave-ao-session.md) (`npm run nano:ao:session`); AO1 [H-GENCORE HOLD](docs/results/nano-lm/formal-hgencore-gencore.md) (`npm run nano:gencore`); next AO2 H-CTXCORE; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AP.

...
5. `.local/pesquisa.md` (lab **NO-REOPEN** KILLs; Waves W–AA **COMPLETE**; **Wave AB OPEN** — AB0–AB5 **DONE** · [formal-hrealapp-realapp.md](docs/results/nano-lm/formal-hrealapp-realapp.md))
...
- **Wave AB OPEN** — AB0–AB5 **PROMOTE** — [formal-hrealapp-realapp.md](docs/results/nano-lm/formal-hrealapp-realapp.md); next **AB6 AB-HITL-10**.

...
5. `.local/pesquisa.md` (Wave W COMPLETE; Wave X ACTIVE — H-TCHR/H-QT PROMOTE; H-RAG/H-CTX/H-CKD/H-QCTX/H-QCOMP KILL; next H-Q-QUBITKV) before new H-IDs
...
- **Wave X ACTIVE** — H-TCHR/H-QT **PROMOTE**; H-RAG/H-CTX/H-CKD/H-QCTX/H-QCOMP **KILL**; next H-Q-QUBITKV — see `.local/pesquisa.md` + [`formal-htchr-code-teacher.md`](docs/results/nano-lm/formal-htchr-code-teacher.md) · [`formal-hqt-quantize.md`](docs/results/nano-lm/formal-hqt-quantize.md).

...
- **Wave AJ OPEN** — AJ0 [SESSION PROMOTE](docs/results/nano-lm/wave-aj-session.md) (`npm run nano:aj:session`); AJ1 [H-GENPEAK PROMOTE](docs/results/nano-lm/formal-hgenpeak-genpeak.md) (`npm run nano:genpeak`); next **AJ2 H-CTXPEAK**; ship claim remains **AF packaged stack**; ≤5M stays; no Wave AK invent without reopen.

...
- **Wave AF OPEN** — AF0 [wave-af-session.md](docs/results/nano-lm/wave-af-session.md) **PROMOTE** (`npm run nano:af:session`); next **H-CTXULTRA**; no Wave AG invent without reopen.

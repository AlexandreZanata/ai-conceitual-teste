...
5. `.local/pesquisa.md` (Wave W COMPLETE; Wave X ACTIVE — H-TCHR/H-QT PROMOTE; H-RAG/H-CTX/H-CKD/H-QCTX KILL; next H-QCOMP) before new H-IDs
...
- **Wave X ACTIVE** — H-TCHR/H-QT **PROMOTE**; H-RAG/H-CTX/H-CKD/H-QCTX **KILL**; next H-QCOMP — see `.local/pesquisa.md` + [`formal-htchr-code-teacher.md`](docs/results/nano-lm/formal-htchr-code-teacher.md) · [`formal-hqt-quantize.md`](docs/results/nano-lm/formal-hqt-quantize.md).

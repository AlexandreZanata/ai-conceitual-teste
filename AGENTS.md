...
- **Wave AM OPEN** — AM0 [SESSION PROMOTE](docs/results/nano-lm/wave-am-session.md) (`npm run nano:am:session`); AM1 [H-GENTRUTH HOLD](docs/results/nano-lm/formal-hgentruth-gentruth.md) (`npm run nano:gentruth`); next AM2 H-CTXNEXT; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AN.

...
5. `.local/pesquisa.md` (lab **NO-REOPEN** KILLs; Waves W–AA **COMPLETE**; **Wave AB OPEN** — AB0–AB1 **DONE** · [formal-hsemwrap-semwrap.md](docs/results/nano-lm/formal-hsemwrap-semwrap.md))
...
- **Wave AB OPEN** — AB0 SESSION **PROMOTE** · AB1 **H-SEMWRAP PROMOTE** — [wave-ab-session.md](docs/results/nano-lm/wave-ab-session.md) · [formal-hsemwrap-semwrap.md](docs/results/nano-lm/formal-hsemwrap-semwrap.md); next **AB2 H-ASKFAST**.

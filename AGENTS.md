...
5. `.local/pesquisa.md` (Wave Y ACTIVE — serve-cache **H-BEAMKV/H-TCACHE/H-SCORERAM PROMOTE**; next **H-PFB256**) before new H-IDs
...
- **Wave Y ACTIVE** — serve-cache **PROMOTE** (BEAMKV/TCACHE/SCORERAM); next **H-PFB256** — see `.local/pesquisa.md` + [`wave-y-summary.md`](docs/results/nano-lm/wave-y-summary.md) · [`formal-hscoreram-scoreram.md`](docs/results/nano-lm/formal-hscoreram-scoreram.md).

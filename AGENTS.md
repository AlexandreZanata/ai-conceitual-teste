...
5. `.local/pesquisa.md` (lab **NO-REOPEN** KILLs; Waves W–AA **COMPLETE**; **Wave AB OPEN** — AB0–AB2 **DONE** · [formal-haskfast-askfast.md](docs/results/nano-lm/formal-haskfast-askfast.md))
...
- **Wave AB OPEN** — AB0–AB2 **PROMOTE** (SESSION · SEMWRAP · ASKFAST) — [formal-haskfast-askfast.md](docs/results/nano-lm/formal-haskfast-askfast.md); next **AB3 H-LONGAPP**.

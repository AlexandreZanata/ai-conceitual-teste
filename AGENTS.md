...
- **Wave AI OPEN** — AI0 [SESSION PROMOTE](docs/results/nano-lm/wave-ai-session.md); AI1 [H-GENPLUS HOLD](docs/results/nano-lm/formal-hgenplus-genplus.md); AI1b [H-CAPRENEG HOLD](docs/results/nano-lm/formal-hcapreneg-capreneg.md) (`npm run nano:capreneg`) — **≤5M stays**; next **AI2 H-CTXPUSH**; ship claim remains **AF packaged stack**; no Wave AJ invent without reopen.

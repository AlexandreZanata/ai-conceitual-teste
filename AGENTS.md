...
- **Wave AM OPEN** — AM0 [SESSION PROMOTE](docs/results/nano-lm/wave-am-session.md) (`npm run nano:am:session`); next AM1 H-GENTRUTH; ship claim remains **AF packaged stack**; ≤5M stays; do not invent Wave AN.

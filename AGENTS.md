...
5. `.local/pesquisa.md` (Wave W COMPLETE; Wave X ACTIVE — H-TCHR PROMOTE; H-RAG/H-CTX KILL; next H-QT) before new H-IDs
...
- **Wave X ACTIVE** — H-TCHR **PROMOTE**; H-RAG/H-CTX **KILL**; next H-QT — see `.local/pesquisa.md` + [`formal-htchr-code-teacher.md`](docs/results/nano-lm/formal-htchr-code-teacher.md) · [`archive/hrag-retrieve.md`](docs/results/nano-lm/archive/hrag-retrieve.md) · [`archive/hctx-long-window.md`](docs/results/nano-lm/archive/hctx-long-window.md).

...
5. `.local/pesquisa.md` (Wave Y ACTIVE — PFB256/ROLL/SUMCACHE **PROMOTE**; STREAM **KILL**; next **H-KVCACHE-Q**) before new H-IDs
...
- **Wave Y ACTIVE** — PFB256/ROLL/SUMCACHE **PROMOTE**; STREAM **KILL**; next **H-KVCACHE-Q** — see `.local/pesquisa.md` + [`wave-y-summary.md`](docs/results/nano-lm/wave-y-summary.md) · [`formal-hsumcache-sumcache.md`](docs/results/nano-lm/formal-hsumcache-sumcache.md).
